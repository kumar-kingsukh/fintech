module.exports = function(res, fs, result, plusvalue, inputQuan, benchMark, com, typo, addmul, initialStrike, checked, currency, underlyings, dontSquare, peDataThisMonthSixteen, ceDataThisMonthSixteen, peDataNextMonthSixteen, ceDataNextMonthSixteen, peDataThisMonthFifteen, ceDataThisMonthFifteen, peDataNextMonthFifteen, ceDataNextMonthFifteen, nseYear, strikeData, onwhich, towhich) {
    ...
    var underlyingsArray = ["29-Jan-13", "26-Feb-13", "25-Mar-13", "26-Apr-13", "29-May-13", "26-Jun-13", "29-Jul-13", "28-Aug-13", "26-Sep-13", "29-Oct-13", "27-Nov-13", "27-Dec-13", "29-Jan-14", "26-Feb-14", "27-Mar-14", "28-Apr-14", "28-May-14", "26-Jun-14", "29-Jul-14", "27-Aug-14", "26-Sep-14", "29-Oct-14", "26-Nov-14", "29-Dec-14", "28-Jan-15", "25-Feb-15", "27-Mar-15", "28-Apr-15", "27-May-15", "26-Jun-15", "29-Jul-15", "27-Aug-15", "28-Sep-15", "28-Oct-15", "26-Nov-15", "29-Dec-15", "27-Jan-16", "25-Feb-16", "29-Mar-16", "27-Apr-16", "27-May-16", "28-Jun-16", "27-Jul-16", "29-Aug-16", "28-Sep-16", "26-Oct-16", "28-Nov-16", "28-Dec-16"];
            ...
            putCP: function(superSupreme) {
                ...
                function applyCallPut(superSupreme) {
                                    ...
                                    for (var j = 0; j < tradeArray.length; j++) {
                                        if (tradeArray[j][1] == "2") {
                                            ...
                                            if (tradeType == "buy") {
                                                ...
                                                //new logic added from here
                                                var toPut = 0;

                                                for (var t = 0; t < coverMeBuy.length; t++) {
                                                    if (coverMeBuy[t][8] == 2) {
                                                        if (coverMeBuy[t][10] == buyFirstStrikeTmDiv) {
                                                            coverMeBuy.splice(t, 1);
                        ...
                        if ((superSupreme[v]["DATE"] != null) && (superSupreme[v]["DATE"] !== undefined) && (underlyingsArray.indexOf(superSupreme[v]["DATE"].toString()) > -1)) {
                            ...
                            for (var t = 0; t < coverMeBuy.length; t++) {
                                if (coverMeBuy[t][6] == 0) {
                                    ...
                                    if ((i > parseInt(coverMeBuy[t][3])) && returnGreatorDate(superSupreme[i]["DATE"], coverMeBuy[t][7]) && (coverMeBuy[t][8] == 2)) {

                                        for (var a = buyFirstStrikeTmDiv; a >= 1; a--) {

                                            if (((parseFloat(coverMeBuy[t][4]) - parseFloat(superSupreme[i]["LOW"])) >= (buyFirstStrikeTmAt * a))) {
                                        ...
                                        for (var a = buyFirstStrikeNmDiv; a >= 1; a--) {
                                            ...
                                            if (((parseFloat(coverMeBuy[t][4]) - parseFloat(superSupreme[i]["LOW"])) >= (buyFirstStrikeNmAt * a))) {
                                    ...
                                    if ((i > parseInt(coverMeBuy[t][3])) && returnGreatorDate(superSupreme[i]["DATE"], coverMeBuy[t][7]) && (coverMeBuy[t][8] == 4)) {

                                        for (var a = buySecondStrikeTmDiv; a >= 1; a--) {

                                            if (((parseFloat(coverMeBuy[t][4]) - parseFloat(superSupreme[i]["LOW"])) >= (buySecondStrikeTmAt * a))) {
                                        ...
                                        for (var a = buySecondStrikeNmDiv; a >= 1; a--) {
                                            ...
                                            if (((parseFloat(coverMeBuy[t][4]) - parseFloat(superSupreme[i]["LOW"])) >= (buySecondStrikeNmAt * a))) {
                                    ...
                                    if ((i > parseInt(coverMeBuy[t][3])) && returnGreatorDate(superSupreme[i]["DATE"], coverMeBuy[t][7]) && (coverMeBuy[t][8] == 6)) {

                                        for (var a = buyThirdStrikeTmDiv; a >= 1; a--) {

                                            if (((parseFloat(coverMeBuy[t][4]) - parseFloat(superSupreme[i]["LOW"])) >= (buyThirdStrikeTmAt * a))) {
                                        ...
                                        for (var a = buyThirdStrikeNmDiv; a >= 1; a--) {
                                            ...
                                            if (((parseFloat(coverMeBuy[t][4]) - parseFloat(superSupreme[i]["LOW"])) >= (buyThirdStrikeNmAt * a))) {
                                    ...
                                    if ((i > parseInt(coverMeBuy[t][3])) && returnGreatorDate(superSupreme[i]["DATE"], coverMeBuy[t][7]) && (coverMeBuy[t][8] == 26)) {
                            ...
                            for (var t = 0; t < coverMeSell.length; t++) {
                                ...
                                if (coverMeSell[t][6] == 0) {
                                    ...
                                    if ((i > parseInt(coverMeSell[t][3])) && returnGreatorDate(superSupreme[i]["DATE"], coverMeSell[t][7]) && (coverMeSell[t][8] == 13)) {

                                        for (var a = sellFirstStrikeTmDiv; a >= 1; a--) {

                                            if (((parseFloat(superSupreme[i]["HIGH"]) - parseFloat(coverMeSell[t][4])) >= (sellFirstStrikeTmAt * a))) {
                                        ...
                                        for (var a = sellFirstStrikeNmDiv; a >= 1; a--) {
                                            ...
                                            if (((parseFloat(superSupreme[i]["HIGH"]) - parseFloat(coverMeSell[t][4])) >= (sellFirstStrikeNmAt * a))) {
                                    ...
                                    if ((i > parseInt(coverMeSell[t][3])) && returnGreatorDate(superSupreme[i]["DATE"], coverMeSell[t][7]) && (coverMeSell[t][8] == 15)) {

                                        for (var a = sellSecondStrikeTmDiv; a >= 1; a--) {

                                            if (((parseFloat(superSupreme[i]["HIGH"]) - parseFloat(coverMeSell[t][4])) >= (sellSecondStrikeTmAt * a))) {
                                        ...
                                        for (var a = sellSecondStrikeNmDiv; a >= 1; a--) {
                                            ...
                                            if (((parseFloat(superSupreme[i]["HIGH"]) - parseFloat(coverMeSell[t][4])) >= (sellSecondStrikeNmAt * a))) {
                                    ...
                                    if ((i > parseInt(coverMeSell[t][3])) && returnGreatorDate(superSupreme[i]["DATE"], coverMeSell[t][7]) && (coverMeSell[t][8] == 17)) {

                                        for (var a = sellThirdStrikeTmDiv; a >= 1; a--) {

                                            if (((parseFloat(superSupreme[i]["HIGH"]) - parseFloat(coverMeSell[t][4])) >= (sellThirdStrikeTmAt * a))) {
                                        ...
                                        for (var a = sellThirdStrikeNmDiv; a >= 1; a--) {
                                            ...
                                            if (((parseFloat(superSupreme[i]["HIGH"]) - parseFloat(coverMeSell[t][4])) >= (sellThirdStrikeNmAt * a))) {
                                    ...
                                    if ((i > parseInt(coverMeSell[t][3])) && returnGreatorDate(superSupreme[i]["DATE"], coverMeSell[t][7]) && (coverMeSell[t][8] == 29)) {
                    ...
                    var toRetNQBuy = function(i, whereat, amount) {
                        ...
                        if ((superSupreme[i]["DATE"] != null) && (superSupreme[t]["DATE"] !== undefined) && (checkFirstDay(superSupreme[i]["DATE"]))) {
                            return 0;
                        }
