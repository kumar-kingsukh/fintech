module.exports = function(res, fs, result, plusvalue, inputQuan, benchMark, com, typo, addmul, initialStrike, checked, currency, underlyings, dontSquare, peDataThisMonthSixteen, ceDataThisMonthSixteen, peDataNextMonthSixteen, ceDataNextMonthSixteen, peDataThisMonthFifteen, ceDataThisMonthFifteen, peDataNextMonthFifteen, ceDataNextMonthFifteen, nseYear, strikeData, onwhich, towhich) {
    ...
    return {
        ...
        functions: {
            putCP: function(superSupreme) {
                ...
                var createFile = function(arr, type) {
                    ...
                    if (type == 1 || type == 2) {
                        var filename = "download.csv"; //Math.floor((Math.random()*10000000))+".xlsx";
                        try {
                            var dir = './tmp/';
                            ...
                            var csv = parser.parse(arr);

                            fs.writeFileSync(dir + filename, csv, 'binary');
                            if (type == 2) {
                    ...
                    var getCEThisMonthUSDINR = function(date, strikePrice) {
                        for (var i = 0; i < ceDataThisMonth.length; i++) {

                            if (onwhich == "/BHEL2015" || onwhich == "/AXISBANK2015" || onwhich == "/COALINDIA2015" || onwhich == "/HDFC2015" || onwhich == "/HINDALCO2015" || onwhich == "/ICICIBANK2015" || onwhich == "/INFY2015" || onwhich == "/ITC2015" || onwhich == "/ONGC2015" || onwhich == "/SBIN2015") {
                                var day = ceDataThisMonth[i]["Date"].substring(0, 2);
                                var month = ceDataThisMonth[i]["Date"].substring(3, 6);
                                var year = ceDataThisMonth[i]["Date"].substring(9, 11);
                            } else {
                    ...
                    var getPEThisMonthUSDINR = function(date, strikePrice) {
                        for (var i = 0; i < peDataThisMonth.length; i++) {

                            if (onwhich == "/BHEL2015" || onwhich == "/AXISBANK2015" || onwhich == "/COALINDIA2015" || onwhich == "/HDFC2015" || onwhich == "/HINDALCO2015" || onwhich == "/ICICIBANK2015" || onwhich == "/INFY2015" || onwhich == "/ITC2015" || onwhich == "/ONGC2015" || onwhich == "/SBIN2015") {
                                var day = peDataThisMonth[i]["Date"].substring(0, 2);
                                var month = peDataThisMonth[i]["Date"].substring(3, 6);
                                var year = peDataThisMonth[i]["Date"].substring(9, 11);
                            } else {
                    ...
                    var getCENextMonthUSDINR = function(date, strikePrice) {
                    ...
                    var getPENextMonthUSDINR = function(date, strikePrice) {
                    ...
                    switch (onwhich) {
                        ...
                        case "/nifty":
                            ...
                            break;
                        case "/usdinr2013":
                            highest = (Math.ceil(highest / 0.5) * 0.5) + 1;
                            lowest = (Math.floor(lowest / 0.5) * 0.5) - 1;
                        ...
                        case "/usdinr2016":
                            ...
                            break;
                        case "/BHEL2015":
                            highest = (Math.ceil(highest / 10) * 10) + 20;
                            lowest = (Math.floor(lowest / 10) * 10) - 20;
                            looper = (highest - lowest) / 10;
                            break;
                        case "/AXISBANK2015":
                            highest = (Math.ceil(highest / 10) * 10) + 20;
                            lowest = (Math.floor(lowest / 10) * 10) - 20;
                    ...
                    for (var i = 0; i < superSupreme.length; i++) {
                        ...
                        switch (onwhich) {
                            ...
                            case "/usdinr2016":
                                ...
                                break;
                            case "/BHEL2015":
                                basePrice = Math.ceil(currentPrice / 10) * 10;
                                break;
                            case "/AXISBANK2015":
                                basePrice = Math.ceil(currentPrice / 10) * 10;
                                break;
                        ...
                        if (superSupreme[i]["DATE"] != "" && superSupreme[i]["DATE"] != null) {
                            currentPrice = pf(superSupreme[i]["LTP"]);
                                    ...
                                    for (var j = 0; j < tradeArray.length; j++) {
                                        if (tradeArray[j][1] == "1") {
                                            ...
                                            if (tradeType == "buy") {
                                                ...
                                                coverMeBuy.push(["buy", "CE", "T", i, firstStrike, buyFirstTmQty, 0, superSupreme[i]["DATE"], 2]);
                                    ...
                                    for (var j = 0; j < tradeArray.length; j++) {
                                        if (tradeArray[j][1] == "3") {
                                            ...
                                            if (tradeType == "buy") {
                                                ...
                                                coverMeBuy.push(["buy", "CE", "T", i, secondStrike, buySecondTmQty, 0, superSupreme[i]["DATE"], 4]);
                                                superSupreme[i]["CE STK " + (defendingStrikePrice)] = defendingStrikePrice;
                                                if (towhich == 1) {
                                                    premiumPrice = pf(getCEThisMonthUSDINR(superSupreme[i]["DATE"], defendingStrikePrice));
                                                } else {
                                    ...
                                    for (var j = 0; j < tradeArray.length; j++) {
                                        if (tradeArray[j][1] == "5") {
                                            ...
                                            if (tradeType == "buy") {
                                                ...
                                                coverMeBuy.push(["buy", "CE", "T", i, thirdStrike, buyThirdTmQty, 0, superSupreme[i]["DATE"], 6]);
                                                superSupreme[i]["CE STK " + (defendingStrikePrice)] = defendingStrikePrice;
                                                if (towhich == 1) {
                                                    premiumPrice = pf(getCEThisMonthUSDINR(superSupreme[i]["DATE"], defendingStrikePrice));
                                                } else {
                        ...
                        if ((superSupreme[v]["DATE"] != null) && (superSupreme[v]["DATE"] !== undefined) && (underlyingsArray.indexOf(superSupreme[v]["DATE"].toString()) > -1)) {
                            ...
                            for (var t = 0; t < coverMeBuy.length; t++) {
                                ...
                                if (coverMeBuy[t][6] == 0) {
                                    ...
                                    //console.log("Return date :"+returnGreatorDate(superSupreme[v]["DATE"], coverMeBuy[t][7])+" if to do "+(coverMeBuy[t][8] == 2));
                    ...
                    var getNextEntry = function(i) {
                        for (var t = i + 1; t < superSupreme.length; t++) {
                            if (superSupreme[t]["DATE"] !== null && superSupreme[t]["DATE"] != "") {
                                return t;
                            }
                        }
                    }

                    var checkLastThursday = function(date) {
                        var camein = date;
                        ...
                        if (date.toString() == lastThursday.toString() || camein == "25-Jan-2017") {
                            return true;
                        } else {
                            return false;
                        }
                    ...
                    for (var v = 0; v < superSupreme.length; v++) {
                        var date = superSupreme[v]["DATE"];
                        if (date != "" && date != null) {
                            if (checkLastThursday(superSupreme[v]["DATE"])) {
                                lastThursdays.push(superSupreme[v]["DATE"]);
                    ...
                    var toRetNQBuy = function(i, whereat, amount) {
                        ...
                        if (checkFirstDay(superSupreme[i]["DATE"])) {
                            return 0;
                        }
                    ...
                    var getBuyNQ = function(i, whereat, amount) {
                        ...
                        } else if (checkFirstDay(superSupreme[i]["DATE"])) {
                            ...
                            if (checkFirstDay(date, 1)) {
                                ...
                                for (var k = looper; k >= 0; k--) {
                                    ...
                                    if (nq < 0) {
                                        ...
                                        if (towhich == 1) {
                                            superSupreme[i - 1]["PE BP " + ((lowest + (k * nQuan)))] = pf(getPEThisMonthUSDINR(date, defendingStrikePrice));
                                        } else {
                                    ...
                                    if (nq > 0) {
                                        ...
                                        var defendingStrikePrice = ((lowest + (k * nQuan)));
                                        if (towhich == 1) {
                                            superSupreme[i - 1]["PE sp " + ((lowest + (k * nQuan)))] = pf(getPEThisMonthUSDINR(date, defendingStrikePrice));
                                        } else {
                                    ...
                                    if (NQ < 0) {
                                        ...
                                        var defendingStrikePrice = ((lowest + (k * nQuan)));
                                        if (towhich == 1) {
                                            superSupreme[i - 1]["PE bp " + ((lowest + (k * nQuan)))] = pf(getPENextMonthUSDINR(date, defendingStrikePrice));
                                        } else {
                                    ...
                                    if (NQ > 0) {
                                        ...
                                        var defendingStrikePrice = ((lowest + (k * nQuan)));
                                        if (towhich == 1) {
                                            superSupreme[i - 1]["PE SP " + ((lowest + (k * nQuan)))] = pf(getPENextMonthUSDINR(date, defendingStrikePrice));
                                        } else {
                                    ...
                                    superSupreme[i - 1]["PE nq " + ((lowest + (k * nQuan)))] = (superSupreme[i - 1]["PE nq " + ((lowest + (k * nQuan)))] + superSupreme[i - 1]["PE BQ " + ((lowest + (k * nQuan)))] + superSupreme[i - 1]["PE sq " + ((lowest + (k * nQuan)))]);

                                    totalnqPE += superSupreme[i - 1]["PE nq " + ((lowest + (k * nQuan)))];

                                    superSupreme[i - 1]["PE nv " + ((lowest + (k * nQuan)))] = (superSupreme[i - 1]["PE nv " + ((lowest + (k * nQuan)))] + superSupreme[i - 1]["PE BV " + ((lowest + (k * nQuan)))] + superSupreme[i - 1]["PE sv " + ((lowest + (k * nQuan)))]);
                                ...
                                superSupreme[i - 4]["X-X-X"] = "PE";
                                superSupreme[i - 3]["X-X-X"] = totalNetValuePE;
                                superSupreme[i - 2]["X-X-X"] = "MONTH END";
                    ...
                    for (var i = 0; i < superSupreme.length; i++) {
                        ...
                        if (date != null && date != "") {
                            ...
                            if (checkFirstDay(superSupreme[i]["DATE"], 1)) {
                                ...
                                for (var k = looper; k >= 0; k--) {
                                    ...
                                    superSupreme[i - 1]["CE nq " + ((lowest + (k * nQuan)))] = (superSupreme[i - 1]["CE nq " + ((lowest + (k * nQuan)))] + superSupreme[i - 1]["CE BQ " + ((lowest + (k * nQuan)))] + superSupreme[i - 1]["CE sq " + ((lowest + (k * nQuan)))]);

                                    totalnqCE += superSupreme[i - 1]["CE nq " + ((lowest + (k * nQuan)))];

                                    superSupreme[i - 1]["CE nv " + ((lowest + (k * nQuan)))] = (superSupreme[i - 1]["CE nv " + ((lowest + (k * nQuan)))] + superSupreme[i - 1]["CE BV " + ((lowest + (k * nQuan)))] + superSupreme[i - 1]["CE sv " + ((lowest + (k * nQuan)))]);
                                ...
                                superSupreme[i - 6]["X-X-X"] = "CE";
                                superSupreme[i - 5]["X-X-X"] = totalNetValueCE;
            ...
            putTNV: function(arr, callback) {
                ...
                var getPreviousLNV = function(i) {
                    ...
                    if (supremeArray[i]["NV"] == "" && parseInt(supremeArray[i]["NV"]) == 0) {
                        return 0;
                    }
                    ...
                    if (supremeArray[i]["NV"] != "") {
                        ...
                        for (var t = i; t >= 0; t--) {
                            ...
                            if (supremeArray[t]["NV"] == "" && parseInt(supremeArray[t]["NV"]) == 0) {
                                return 0;
                            }
                ...
                for (var i = 1; i < supremeArray.length; i++) {
                    ...
                    if (currency == 1) {
                        ...
                        if (underlyings == 1) {
                            ...
                            if (supremeArray[i]["DATE"] != "") {
                                if (underlyingsArray.indexOf(getPreviousDate(i)) > -1) {
                                    supremeArray[i - 1]["X-X-X"] = getPreviousRNV(i) + getPreviousLNV(i);
                                }
                            }
                        ...
                        if ((supremeArray[i]["DATE"] != "") && checkLastThursday(getPreviousDate(i))) {
                            if (towhich == 1) {
                ...
                console.log("came here over super supreme");


                console.log(superSupreme);
            ...
            checkLastThursday: function(date) {
                var camein = date;
                var date = new Date(date);
                var gd = date.getDate();
                var gy = date.getFullYear();
        ...
        algoOne: function() {
            ...
            con.connect(function(err) {
                if (err) {
                    ...
                    var putGapAfterLastThursday = function(arr, callback) {
                        var getPreviousDate = function(i) {
                            var i = i - 1;
                            if (arr[i]["Date"] != "") {
                                return arr[i]["Date"];
                        ...
                        for (var i = 1; i < arr.length; i++) {
                            if ((arr[i]["Date"] != "") && (that.functions.checkLastThursday(getPreviousDate(i)))) {
                                arr.splice(i, 0, {
                                    "Date": "",
                                    "Open": "",
                                    "Low": "",
                    ...
                    var putAverage = function(arr, callback) {
                        ...
                        if (currency == 1) {
                            ...
                            callback(arr, putGapAfterLastThursday);
                        }
                    }
                            ...
                            for (var i = 0; i < rows.length; i++) {
                                if (i == 0) {
                                    ...
                                    if (currency == 1) {
                                        ...
                                        if ((rows[i]["Date"]) != "" && that.functions.checkLastThursday(getPreviousDate(i))) {
                                            if (rows[i]["SP"] == null && rows[i]["BP"] != null) {
                                                rows[i]["NV"] = that.maths.pf(rows[i]["BV"]);
                                            }
                                            if (rows[i]["SP"] != null && rows[i]["BP"] != null) {
                        ...
                        if (dontSquare == 1) {
                            ...
                            for (var i = setIt; i < arr.length; i++) {
                                ...
                                if (currency == 1) {
                                    ...
                                    if (that.functions.checkLastThursday(date)) {
                                        for (var j = 0; j <= i; j++) {
                                            if (arr[j]["status"] == 1) {
                                                continue;
                                            } else {
        ...
        algoTwo: function(arr1) {
            ...
            var putGapAfterLastThursday = function(rows, callback) {
                var getPreviousDate = function(i) {
                    var i = i - 1;
                    if (rows[i]["Date"] != "") {
                        return rows[i]["Date"];
            ...
            var putAverage = function(rows, callback) {
                ...
                if (currency == 1) {
                    ...
                    callback(rows, putGapAfterLastThursday);
                }
            }
                ...
                if (dontSquare == 1) {
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        if (currency == 1) {
                            ...
                            } else if ((rows[i]["Date"] != "") && that.functions.checkLastThursday(getPreviousDate(i))) {
                                if (rows[i]["BP"] === null) {
                                    rows[i]["NV"] = -Math.abs(that.maths.pf(rows[i]["SV"]));
                                } else {
                                    rows[i]["NV"] = that.maths.pf(rows[i]["BV"]) - that.maths.pf(rows[i]["SV"]);
                ...
                if (dontSquare == 1) {
                    ...
                    for (var i = setIt; i < arr.length; i++) {
                        ...
                        if (currency == 1) {
                            ...
                            if (that.functions.checkLastThursday(arr[i]["Date"])) {
                                for (var j = 0; j <= i; j++) {
                                    if (arr[j]["status"] == 1) {
                                        continue;
                                    } else {
        ...
        algoThree: function() {
            var that = this;
            var linker = [];
            var getTheLink = function() {
                res.emit('progressLane', "Getting the links.");
                url = "http://www.moneycontrol.com/earnings/results-calender.html";
                request(url, function(error, response, html) {
                    var $ = cheerio.load(html);
                    $('.PB20 li:nth-child(2)').filter(function() {
                        var link = $(this).children().attr('href');
                        var patt = /_/;
                        var place = link.search(patt);
                        before = link.substring(0, place + 1);
                        after = link.substring(place + 2, link.length);
                        linker.push(before, after);
                    });
                });
                pushTheData(1);
            }
            ...
            var getTheData = function() {
                res.emit('progressLane', "Compiling the data");
                con.query("SELECT * FROM  moneycontrol", function(err, rows, fields) {
                    if (err) {
                        throw err;
                    } else {
                        that.functions.createFile(rows, 2);
                    }
                });
            }
            ...
            var convertTable = function(data) {
                ...
                $('div.MT15 table').each(function(i, table) {
                    var tableAsJson = [];
                    var columnHeadings = [];
            ...
            var pushTheData = function(page) {
                if (linker.length != 0) {
                    url = "http://www.moneycontrol.com/earnings/" + linker[0] + page + linker[1];
                }
                request(url, function(error, response, html) {
                    if (!error) {
                        var toPush = [];
                        var tablesAsJson = JSON.stringify(convertTable(html));
                        var arr = JSON.parse(tablesAsJson.slice(1, -1));
                        for (var i = 0; i < arr.length; i++) {
                            toPush.push([arr[i]["Company Name"], arr[i]["Date"], arr[i]["Last Price"], arr[i]["%Change"], arr[i]["52-week High"], arr[i]["52-week Low"]]);
                        }
                        con.query('INSERT INTO moneycontrol (`Company Name`, `Date`, `Last Price`, `%Change`, `52-week High`, `52-week Low`) VALUES ?', [toPush], function(err, response) {
                            if (err) {
                                throw err;
                            } else {
                                var $ = cheerio.load(html);
                                $('.PB20 ul').filter(function() {
                                    var count = $(this).children().length;
                                    $('.PB20 li:nth-child(' + count + ')').filter(function() {
                                        var check = $(this).text().trim();
                                        if (check != "Next") {
                                            getTheData();
                                            res.emit('progressLane', "About to download file.");
                                            return false;
                                        } else {
                                            res.emit('progressLane', "Page " + page + " of money control inserted");
                                            page = page + 1;
                                            pushTheData(page);
                                        }
                                    });
            ...
            var createTemporaryDb = function() {
                var query = "CREATE TEMPORARY TABLE `moneycontrol` (`Company Name` text COLLATE utf8mb4_unicode_ci NOT NULL,`Date` text COLLATE utf8mb4_unicode_ci NOT NULL,`Last Price` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL,`%Change` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL,`52-week High` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL,`52-week Low` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci";
                con.query(query, function(err, response) {
                    if (err) {
                        throw err;
                    } else {
                        res.emit('progressLane', "Getting things ready");
                        getTheLink();
                    }
                });
            }
        ...
        algoFour: function(res, fs, result, plusvalue, inputquan, meth, addmul) {
            ...
            var addmul = addmul;
            var uploadData = function(arr, callback) {
                logsArray = [];
                for (var i = 0; i < arr.length; i++) {
                    logsArray.push({
                        "DATE": arr[i]["DATE"],
                        "TIME": arr[i]["TIME"],
                        "OPEN": pf(arr[i]["OPEN"]).toFixed(2),
                        "HIGH": pf(arr[i]["HIGH"]).toFixed(2),
                        "LOW": pf(arr[i]["LOW"]).toFixed(2),
                        "CLOSE": pf(arr[i]["CLOSE"]).toFixed(2),
                    });
                }
                callback(logsArray);
            }
            ...
            var plusValue = parseFloat(plusvalue);
            var benchQuant = parseFloat(inputquan);
            var pf = function(a) {
                return parseFloat(a);
            }
            ...
            var putNQ = function(rows, callback) {
                ...
                for (var i = 0; i < rows.length - 1; i++) {
                    if (nqDays.indexOf(rows[i]["DATE"]) <= -1) {
                        if ((rows[i]["BP"] === null) && (rows[i]["SP"] === null)) {
                            rows[i]["NQ"] = 0;
                        }
                        if ((rows[i]["BP"] !== null) && (rows[i]["SP"] === null)) {
                        ...
                        if ((rows[i]["BP"] !== null) && (rows[i]["SP"] !== null)) {
                            rows[i]["NQ"] = rows[i]["BQ"] - rows[i]["SQ"]
                        }
                        if ((rows[i]["BP"] === null) && (rows[i]["SP"] !== null)) {
                            rows[i]["NQ"] = -Math.abs(rows[i]["SQ"]);
                        }
                    } else {
                        if (rows[i]["BP"] == null && rows[i]["SP"] != null) {
                            rows[i]["NQ"] = pi(rows[i - 1]["NQ"]) - pi(rows[i]["SQ"]);
                        }
                        if (rows[i]["BP"] != null && rows[i]["SP"] != null) {
                            rows[i]["NQ"] = (pi(rows[i - 1]["NQ"]) + pi(rows[i]["BQ"])) - pi(rows[i]["SQ"]);
                        }
                        if (rows[i]["BP"] != null && rows[i]["SP"] == null) {
                            rows[i]["NQ"] = pi(rows[i - 1]["NQ"]) + pi(rows[i]["BQ"]);
                        }
                        if (rows[i]["BP"] == null && rows[i]["SP"] == null) {
                            rows[i]["NQ"] = pi(rows[i - 1]["NQ"]);
                        }
                    }


                    if (nqDays.length == 0) {
                        nqDays.push(rows[i]["DATE"]);
                    } else {
                        if (nqDays.indexOf(rows[i]["DATE"]) > -1) {
                ...
                for (var i = 0; i < rows.length - 1; i++) {
                    if (nvDays.indexOf(rows[i]["DATE"]) <= -1) {
                        if ((rows[i]["BP"] === null) && (rows[i]["SP"] === null)) {
                            rows[i]["NV"] = 0;
                        }
                        if ((rows[i]["BP"] !== null) && (rows[i]["SP"] === null)) {
                        ...
                        if ((rows[i]["BP"] !== null) && (rows[i]["SP"] !== null)) {
                            rows[i]["NV"] = rows[i]["BV"] - rows[i]["SV"]
                        }
                        if ((rows[i]["BP"] === null) && (rows[i]["SP"] !== null)) {
                            rows[i]["NV"] = -Math.abs(rows[i]["SV"]);
                        }
                    } else {
                        if (rows[i]["BP"] == null && rows[i]["SP"] != null) {
                            rows[i]["NV"] = pi(rows[i - 1]["NV"]) - pi(rows[i]["SV"]);
                        }
                        if (rows[i]["BP"] != null && rows[i]["SP"] != null) {
                            rows[i]["NV"] = (pi(rows[i - 1]["NV"]) + pi(rows[i]["BV"])) - pi(rows[i]["SV"]);
                        }
                        if (rows[i]["BP"] != null && rows[i]["SP"] == null) {
                            rows[i]["NV"] = pi(rows[i - 1]["NV"]) + pi(rows[i]["BV"]);
                        }
                        if (rows[i]["BP"] == null && rows[i]["SP"] == null) {
                            rows[i]["NV"] = pi(rows[i - 1]["NV"]);
                        }
                    }
                    if (nvDays.length == 0) {
                        nvDays.push(rows[i]["DATE"]);
                    } else {
                        if (nvDays.indexOf(rows[i]["DATE"]) > -1) {
                ...
                for (var i = 0; i < rows.length - 1; i++) {
                    if (rows[i]["NQ"] == 0) {
                        ...
                        rows[i]["AVG"] = pf((pf(rows[i]["NV"]) / pf(rows[i]["NQ"])).toFixed(2));
                    }
                }
                for (var i = 0; i < rows.length - 1; i++) {
                    if (rows[i]["CLOSE"] !== null) {
                        rows[i]["MTM"] = ((pf(rows[i]["AVG"]) - pf(rows[i]["CLOSE"])) * pf(rows[i]["NQ"])).toFixed(2);
                    } else {
                        var getPreviousClose = function(i) {
                            var i = i - 1;
                            if (rows[i]["CLOSE"] !== null) {
                                return rows[i]["CLOSE"];
                            } else {
                                for (var t = i; t >= 0; t--) {
                                    if (rows[t]["CLOSE"] !== null) {
                                        return rows[t]["CLOSE"];
                                    }
                                }
                            }
                        }
                        rows[i]["MTM"] = ((pf(rows[i]["AVG"]) - pf(getPreviousClose(i))) * pf(rows[i]["NQ"])).toFixed(2);
                    }
                }
                ...
                var getCurrentEntry = function(i) {
                    if (rows[i]["CLOSE"] !== null) {
                        return i;
                    } else {
                        var i = i - 1;
                ...
                var getCurrentEntryLast = function(i) {
                    for (var k = i; k < rows.length - 1; k++) {
                        if ((rows[k]["NQ"] == "") || (rows[k]["NQ"] == null)) {
                            return (k - 1);
                        }
                    }
                }
                ...
                for (var i = 0; i < rows.length; i++) {
                    if (i == rows.length - 1) {
                        currentNQ = pi(rows[i - 1]["NQ"]);
                        currentCLOSE = pf(rows[getCurrentEntry(i)]["CLOSE"]);
                        if (currentNQ == 0) {
                            rows.push({
                                "DATE": null,
                                "TIME": null,
                        ...
                        if (currentNQ > 0) {
                            rows.push({
                                ...
                                "BV": null,
                                "SP": currentCLOSE,
                                "SQ": Math.abs(currentNQ),
                                "SV": (currentCLOSE * Math.abs(currentNQ) - ((currentCLOSE * Math.abs(currentNQ)) * 0.0002)),
                                "NQ": 0,
                                "NV": pf(rows[i]["NV"]) - pf(currentNQ * currentCLOSE),
                                "AVG": 0,
                                "MTM": 0
                            });
                        }
                        if (currentNQ < 0) {
                            rows.push({
                                ...
                                "CLOSE": null,
                                "BP": currentCLOSE,
                                "BQ": Math.abs(currentNQ),
                                "BV": (currentCLOSE * Math.abs(currentNQ) + ((currentCLOSE * Math.abs(currentNQ)) * 0.0002)),
                                "SP": null,
                                "SQ": null,
                                "SV": null,
                                "NQ": 0,
                        ...
                        if (rows[i]["TIME"] == "15:29:00") {
                            currentNQ = pi(rows[getCurrentEntryLast(i)]["NQ"]);
                            currentCLOSE = pf(rows[getCurrentEntry(i)]["CLOSE"]);
                            currentNV = pi(rows[getCurrentEntryLast(i)]["NV"]);

                            if (currentNQ == 0) {
                                rows.splice(getNextEntry(i), 0, {
                                    "DATE": null,
                                    "TIME": null,
                                    "OPEN": null,
                                    "HIGH": null,
                            ...
                            if (currentNQ > 0) {
                                rows.splice(getNextEntry(i), 0, {
                                    ...
                                    "SV": (currentCLOSE * Math.abs(currentNQ) - ((currentCLOSE * Math.abs(currentNQ)) * 0.0002)),
                                    "NQ": 0,
                                    "NV": pi(currentNV) - (currentCLOSE * Math.abs(currentNQ) - ((currentCLOSE * Math.abs(currentNQ)) * 0.0002)),
                                    "AVG": 0,
                                    "MTM": 0
                                });
            ...
            var mergeData = function(logs, callback) {
                callback(logs, downloadData);
            }

            var researchData = function(data) {
                var allDays = [];
                allDays.push(null);
                var buyBelow = [];
                var sellBelow = [];
                for (var i = 0; i < data.length; i++) {
                    data[i]["OPEN"] = (isNaN(data[i]["OPEN"]) ? null : data[i]["OPEN"]);
                    data[i]["HIGH"] = (isNaN(data[i]["HIGH"]) ? null : data[i]["HIGH"]);
                    data[i]["LOW"] = (isNaN(data[i]["LOW"]) ? null : data[i]["LOW"]);
                    data[i]["CLOSE"] = (isNaN(data[i]["CLOSE"]) ? null : data[i]["CLOSE"]);
                    data[i]["BP"] = null;
                    data[i]["BQ"] = null;
                    data[i]["BV"] = null;
                    data[i]["SP"] = null;
                ...
                for (var i = 0; i < data.length - 1; i++) {
                    if (allDays.indexOf(data[i]["DATE"]) > -1) {

                    } else {
                        allDays.push(data[i]["DATE"]);
                        standardBenchMark = pf(data[i]["OPEN"]);
                        BvariableBenchMark = standardBenchMark;
                        HvariableBenchMark = standardBenchMark;
                        benchQuant = parseFloat(inputquan);
                        buyBelow = [];
                        sellBelow = [];
                    }
                    ...
                    if ((data[i]["TIME"] > "09:17:00") && (data[i]["TIME"] < "15:29:00")) {
                        if (buyBelow.length != 0) {
                            for (var j = 0; j < buyBelow.length; j++) {
                                if (buyBelow[j]["buystatus"] == 0) {
                                    if (pf(buyBelow[j]["BP"]) < pf(data[i]["HIGH"])) {
                                        level = Math.abs(getPartsOfPlusValue(pf(buyBelow[j]["BP"]), pf(data[i]["HIGH"])));
                                        if (level != 0) {
                                            buyBelow[j]["buystatus"] = 1;
                                            var sellValue = null;
                                            sellValue = pf(buyBelow[j]["BP"]) + plusValue;
                                            sellBelow.push({
                                                "SP": pf(sellValue),
                                                "SQ": pf(buyBelow[j]["BQ"]),
                                                "rebuystatus": 0
                                            });
                                            data.splice(getNextEntry(i), 0, {
                                                "DATE": null,
                                                "TIME": null,
                                                "OPEN": null,
                                                "HIGH": null,
                                                ...
                                                "BQ": null,
                                                "BV": null,
                                                "SP": sellBelow[sellBelow.length - 1]["SP"],
                                                "SQ": sellBelow[sellBelow.length - 1]["SQ"],
                                                "SV": (sellBelow[sellBelow.length - 1]["SP"] - (sellBelow[sellBelow.length - 1]["SP"] * 0.0002)) * (sellBelow[sellBelow.length - 1]["SQ"])
                                            });
                        ...
                        if (pf(data[i]["HIGH"]) > HvariableBenchMark) {

                            level = Math.abs(getPartsOfPlusValue(data[i]["HIGH"], HvariableBenchMark));
                            for (var j = 1; j <= level; j++) {

                                if (level != 0) {
                                    mul = Math.abs(getPartsOfPlusValue(data[i]["HIGH"], standardBenchMark));

                                    HvariableBenchMark = HvariableBenchMark + (plusValue);

                                    mul = Math.abs(getPartsOfPlusValue(HvariableBenchMark, standardBenchMark));

                                    if (typo == 0) {
                                        sellQuantity = benchQuant + (addmul * (mul - 1));
                                    }

                                    if (typo == 1) {
                                        sellQuantity = benchQuant;
                                    }
                                    ...
                                    if (typo == 2) {
                                        if (mul == 1) {
                                            ...
                                            sellQuantity = benchQuant * Math.pow(addmul, (mul - 1));
                                        }
                                    }

                                    sellBelow.push({
                                        "SP": (pf(HvariableBenchMark)),
                                        "SQ": sellQuantity,
                                        "rebuystatus": 0
                                    });
                        ...
                        if (sellBelow.length != 0) {
                            for (var k = 0; k < sellBelow.length; k++) {
                                if (data[i]["F"] == i) {
                                    continue;
                                }
                                if (sellBelow[k]["rebuystatus"] == 0) {
                                    if (pf(data[i]["LOW"]) < pf(sellBelow[k]["SP"])) {
                                        level = Math.abs(getPartsOfPlusValue(pf(data[i]["LOW"]), pf(sellBelow[k]["SP"])));
                                        if (level != 0) {
                                            sellBelow[k]["rebuystatus"] = 1;
                                            var buyValue = null;
                                            buyValue = pf(sellBelow[k]["SP"]) - plusValue;
                                            buyBelow.push({
                                                "BP": pf(buyValue),
                                                "BQ": pf(sellBelow[k]["SQ"]),
                                                "buystatus": 0
                                            });
                                            data.splice(getNextEntry(i), 0, {
                                                "DATE": null,
                                                ...
                                                "LOW": null,
                                                "CLOSE": null,
                                                "BP": buyBelow[buyBelow.length - 1]["BP"],
                                                "BQ": buyBelow[buyBelow.length - 1]["BQ"],
                                                "BV": (buyBelow[buyBelow.length - 1]["BP"] + (buyBelow[buyBelow.length - 1]["BP"] * 0.0002)) * (buyBelow[buyBelow.length - 1]["BQ"]),
                                                "SP": null,
                                                "SQ": null,
                                                "SV": null,
                                            });
                        ...
                        if (pf(data[i]["LOW"]) < BvariableBenchMark) {

                            level = Math.abs(getPartsOfPlusValue(data[i]["LOW"], BvariableBenchMark));
                            for (var j = 1; j <= level; j++) {

                                if (level != 0) {
                                    mul = Math.abs(getPartsOfPlusValue(data[i]["LOW"], standardBenchMark));

                                    BvariableBenchMark = BvariableBenchMark - (plusValue);

                                    mul = Math.abs(getPartsOfPlusValue(BvariableBenchMark, standardBenchMark));

                                    if (typo == 0) {
                                        buyQuantity = benchQuant + (addmul * (mul - 1));
                                    }

                                    if (typo == 1) {
                                        buyQuantity = benchQuant;
                                    }
                                    ...
                                    if (typo == 2) {
                                        if (mul == 1) {
                                            ...
                                            buyQuantity = benchQuant * Math.pow(addmul, (mul - 1));
                                        }
                                    }

                                    buyBelow.push({
                                        "BP": (pf(BvariableBenchMark)),
                                        "BQ": buyQuantity,
                                        "buystatus": 0
                                    });
                        ...
                        if (buyBelow.length != 0) {
                            for (var j = 0; j < buyBelow.length; j++) {
                                if (buyBelow[j]["buystatus"] == 0) {
                                    if (pf(buyBelow[j]["BP"]) < pf(data[i]["CLOSE"])) {
                                        level = Math.abs(getPartsOfPlusValue(pf(buyBelow[j]["BP"]), pf(data[i]["CLOSE"])));
                                        if (level != 0) {
                                            buyBelow[j]["buystatus"] = 1;
                                            var sellValue = null;
                                            sellValue = pf(buyBelow[j]["BP"]) + plusValue;
                ...
                mergeData(data, putNQ);

            }

            var downloadData = function(dataPieces) {
                dataPieces.pop();
                createFile(dataPieces, 1);
            }
            ...
            var startProcess = function() {
                ...
                uploadData(dataSort(dataClean(result)), researchData);
            }

            startProcess();
        },
        algoFive: function(res, fs, companyname) {
            ...
            var makeRequest = function() {
                ...
                request(url, function(error, response, data) {
                    createFile(crunchData(JSON.parse(data)), 1);
                });
            }

            makeRequest();
        },
        algoSix: function(fr, till, gap, result, fu) {
            ...
            var dataTrimmer = function(arr) {
                for (var i = 0; i < arr.length; i++) {
                    for (key in arr[i]) {
                        if (!((key.indexOf('Date') > -1) || (key.indexOf('Expiry') > -1) || (key.indexOf('Option Type') > -1) || (key.indexOf('Strike Price') > -1) || (key.indexOf('Open') > -1) || (key.indexOf('High') > -1) || (key.indexOf('Low') > -1) || (key.indexOf('LTP') > -1) || (key.indexOf('Last') > -1))) {
                            delete arr[i][key];
                            delete arr[i]["Open Int"];
                        }
                    }
                }

                arr.sort(function(a, b) {
                    var aD = pi(a["Strike Price"]),
                        bD = pi(b["Strike Price"]);
                    return aD < bD ? -1 : (aD > bD ? 1 : 0);
                });
                ...
                for (var i = 0; i < arr.length; i++) {
                    if (strikePricer.length == 0) {
                        strikePricer.push(arr[i]["Strike Price"]);
                    } else {
                        if (strikePricer.indexOf(arr[i]["Strike Price"]) > -1) {
                ...
                for (var i = 0; i < strikePricer.length; i++) {
                    if (gap == 1) {
                        if ((pi(strikePricer[i]) >= fr) && (pi(strikePricer[i]) <= till) && (pi(strikePricer[i]) % 100 == 0)) {
                            strikePrices.push(strikePricer[i]);
                        }
                    } else {
                        if ((pi(strikePricer[i]) >= fr) && (pi(strikePricer[i]) <= till)) {
                            strikePrices.push(strikePricer[i]);
                        }
                    }
                }

                strikePrices.sort(function(a, b) {
                    return a - b
                });

                var dateArray = [];
                for (var v = 0; v < arr.length; v++) {
                    if (dateArray.indexOf(arr[v]["Date"]) > -1) {

                    } else {
                        dateArray.push(arr[v]["Date"]);
                    }
                }
                ...
                for (var t = 0; t < dateArray.length; t++) {
                    ...
                    for (var x = 0; x < dateArray.length; x++) {
                        ...
                        oneTime["Expiry"] = null;
                        oneTime["OP"] = null;
                        oneTime[strikePrices[x] + " Strike"] = null;
                        oneTime[strikePrices[x] + " HI"] = null;
                        oneTime[strikePrices[x] + " LO"] = null;
                        oneTime[strikePrices[x] + " LTP"] = null;
                        oneTime[strikePrices[x] + " GAP"] = null;
                    }
                    helpingArray.push(oneTime);
                    oneTime = {};
                }


                for (var i = 0; i < arr.length; i++) {
                    for (var j = 0; j < strikePrices.length; j++) {
                        if (arr[i]["Strike Price"] == strikePrices[j]) {
                            for (var k = 0; k < dateArray.length; k++) {
                                if (arr[i]["Date"] == dateArray[k]) {
                                    helpingArray[k]["Date"] = arr[i]["Date"];
                                    helpingArray[k]["Expiry"] = arr[i]["Expiry"];
                                    helpingArray[k]["OP"] = arr[i]["Option Type"];
                                    helpingArray[k][strikePrices[j] + " Strike"] = arr[i]["Open"];
                                    helpingArray[k][strikePrices[j] + " HI"] = arr[i]["High"];
                                    helpingArray[k][strikePrices[j] + " LO"] = arr[i]["Low"];
                                    helpingArray[k][strikePrices[j] + " LTP"] = arr[i]["LTP"];
                                    helpingArray[k][strikePrices[j] + " GAP"] = null;
                                }
                            }
                ...
                helpingArray.sort(function(a, b) {
                    var aDate = a["Date"];
                    var bDate = b["Date"];
                    var aa = aDate.replace("Jan", "01").replace("Feb", "02").replace("Mar", "03").replace("Apr", "04").replace("May", "05").replace("Jun", "06").replace("Jul", "07").replace("Aug", "08").replace("Sep", "09").replace("Oct", "10").replace("Nov", "11").replace("Dec", "12");
                    var bb = bDate.replace("Jan", "01").replace("Feb", "02").replace("Mar", "03").replace("Apr", "04").replace("May", "05").replace("Jun", "06").replace("Jul", "07").replace("Aug", "08").replace("Sep", "09").replace("Oct", "10").replace("Nov", "11").replace("Dec", "12");
                ...
                for (var i = 0; i < helpingArray.length; i++) {
                    arrv.push(Object.keys(helpingArray[i]).map(function(k) {
                        return helpingArray[i][k];
                    }));
                }
                finalArray = [];
                finalArray[0] = [];
                finalArray[0].push("Date");
                finalArray[0].push("Expiry");
                finalArray[0].push("OP");
                for (var i = 0; i < strikePrices.length; i++) {
                    finalArray[0].push(strikePrices[i]);
                    finalArray[0].push("HI");
                    finalArray[0].push("LO");
                    finalArray[0].push("LTP");
                    finalArray[0].push(null);
                }

                for (var i = 0; i < arrv.length; i++) {
                    finalArray.push(arrv[i]);
                }
            ...
            var giveFuture = function(arr) {
                ...
                that.functions.createFile(arr, 1);
            }

            if (fu == 1) {
                giveFuture(result);
            } else {
                return dataTrimmer(result);
            }
        },
        algoSeven: function(fr, till, gap, result, fu) {
            ...
            var dataTrimmer = function(arr) {
                for (var i = 0; i < arr.length; i++) {
                    for (key in arr[i]) {
                        if (!((key.indexOf('Trade Date') > -1) || (key.indexOf('Underlyings') > -1) || (key.indexOf('Option Type') > -1) || (key.indexOf('Strike Price') > -1) || (key.indexOf('Open Price') > -1) || (key.indexOf('High Price') > -1) || (key.indexOf('Low Price') > -1) || (key.indexOf('LTP') > -1) || (key.indexOf('Last') > -1) || (key.indexOf('Close Price') > -1))) {
                            delete arr[i][key];
                            delete arr[i]["Open Interest"];
                        }
                    }
                }
                ...
                var dateArray = [];
                for (var v = 0; v < arr.length; v++) {
                    if (dateArray.indexOf(arr[v]["Trade Date"]) > -1) {

                    } else {
                        dateArray.push(arr[v]["Trade Date"]);
                    }
                }
                ...
                for (var i = 0; i < arr.length; i++) {
                    for (var j = 0; j < strikePrices.length; j++) {
                        if (arr[i]["Strike Price"] == strikePrices[j]) {
                            for (var k = 0; k < dateArray.length; k++) {
                                if (arr[i]["Trade Date"] == dateArray[k]) {
                                    helpingArray[k]["Date"] = arr[i]["Trade Date"]; //vivek
                                    helpingArray[k]["Expiry"] = arr[i]["Underlyings"];
                                    helpingArray[k]["OP"] = arr[i]["Option Type"];
                                    helpingArray[k][strikePrices[j] + " Strike"] = arr[i]["Open Price"];
                                    helpingArray[k][strikePrices[j] + " HI"] = arr[i]["High Price"];
                                    helpingArray[k][strikePrices[j] + " LO"] = arr[i]["Low Price"];
                                    helpingArray[k][strikePrices[j] + " LTP"] = arr[i]["Close Price"];
                                    helpingArray[k][strikePrices[j] + " GAP"] = null;
                                }
                            }
            ...
            var giveFuture = function(arr) {
                for (var i = 0; i < arr.length; i++) {
                    for (key in arr[i]) {
                        if (!((key.indexOf('Trade Date') > -1) || (key.indexOf('Contracts') > -1) || (key.indexOf('Open Price') > -1) || (key.indexOf('High Price') > -1) || (key.indexOf('Low Price') > -1) || (key.indexOf('Close Price') > -1))) {
                            delete arr[i][key];
                        }
                    }
                }
        ...
        algoEight: function(res, result, checkAt, benchQuant, addMul, addQuan, firstQuan, typ) {
            ...
            var checkAt = checkAt;
            var fs = require("fs");
            var benchQuant = parseInt(benchQuant);
            ...
            var applyLogic = function(arr) {

                for (var i = 0; i < arr.length; i++) {
                    arr[i]["OH"] = pf(arr[i]["High"]) - pf(arr[i]["Open"]);
                    arr[i]["OL"] = abs(pf(arr[i]["Low"]) - pf(arr[i]["Open"]));
                }
                ...
                for (var i = 0; i < arr.length; i++) {
                    ...
                    oneTime["DATE"] = arr[i]["Date"];
                    oneTime["OPEN"] = pf(pf(arr[i]["Open"]).toFixed(2));
                    oneTime["HIGH"] = pf(pf(arr[i]["High"]).toFixed(2));
                    oneTime["LOW"] = pf(pf(arr[i]["Low"]).toFixed(2));
                    oneTime["LTP"] = pf(pf(arr[i]["LTP"]).toFixed(2));
                    oneTime["OH"] = pf(pf(arr[i]["OH"]).toFixed(2));
                    oneTime["OL"] = pf(pf(arr[i]["OL"]).toFixed(2));
                    oneTime["BP"] = null;
                    oneTime["BQ"] = null;
                    oneTime["BV"] = null;
                    oneTime["SP"] = null;
                    ...
                    var buyParts = abs(pi(pf(pf(arr[i]["OL"]).toFixed(2)) / checkAt));

                    var sellParts = abs(pi(pf(pf(arr[i]["OH"]).toFixed(2)) / checkAt));

                    var looper = (pi(buyParts) > pi(sellParts)) ? pi(buyParts) : pi(sellParts);
                    ...
                    if (buyParts > sellParts) {
                        for (var j = 1; j <= buyParts; j++) {

                            if (j <= sellParts) {

                                if ((addMul != 'null') && (addMul != null)) {
                                    if (j == 1) {
                                        if (firstQuan != 0) {
                                            putQuan = pi(firstQuan);
                                        } else {
                                            putQuan = benchQuant;
                                        }
                                    } else {
                                        ...
                                        if (firstQuan != 0) {
                                            putQuan = (benchQuant * Math.pow(addMul, (j - 2)));
                                        } else {
                                            putQuan = (benchQuant * Math.pow(addMul, (j - 1)));
                                        }
                                    ...
                                    if (firstQuan != 0) {
                                        ...
                                        putQuan = (benchQuant) + (addQuan * (j - 1));
                                    }
                                    ...
                                    if (firstQuan != 0) {
                                        if (j == 1) {
                                            ...
                                            putQuan = (benchQuant) + (addQuan * (j - 2));
                                        }
                                    } else {
                                        putQuan = (benchQuant) + (addQuan * (j - 2));
                                    }
                                ...
                                oneTime["OH"] = null;
                                oneTime["OL"] = null;
                                oneTime["BP"] = pf(arr[i]["Open"]) - (j * checkAt);
                                oneTime["BQ"] = putQuan;
                                oneTime["BV"] = (pf(arr[i]["Open"]) - (j * checkAt)) * putQuan;
                                oneTime["SP"] = null;
                                oneTime["SQ"] = null;
                                oneTime["SV"] = null;
                                oneTime["NQ"] = null;
                                ...
                                oneTime["bq"] = null;
                                oneTime["bv"] = null;
                                oneTime["sp"] = pf(arr[i]["Open"]) + (j * checkAt);
                                oneTime["sq"] = putQuan;
                                oneTime["sv"] = (pf(arr[i]["Open"]) + (j * checkAt)) * putQuan;
                                oneTime["nq"] = null;
                                oneTime["nv"] = null;
                                oneTime["avg"] = null;
                                oneTime["mtm"] = null;
                    ...
                    if (sellParts > buyParts) {
                        for (var j = 1; j <= sellParts; j++) {
                ...
                for (i = 0; i < finalArray.length; i++) {
                    ...
                    var buyParts = abs(pi(pf(pf(finalArray[i]["OL"]).toFixed(2)) / checkAt));
                    var sellParts = abs(pi(pf(pf(finalArray[i]["OH"]).toFixed(2)) / checkAt));

                    looper = (buyParts > sellParts) ? buyParts : sellParts;

                    if (buyParts == sellParts) {
                        looper = sellParts;
                    }

                    if ((buyParts == 0) && (sellParts == 0)) {
                        looper = 1;
                    }
                    ...
                    if (sellParts == buyParts) {
                        ...
                        buyEnd = i + buyParts;
                        sellEnd = i + sellParts;
                        endpoint = (buyEnd > sellEnd) ? buyEnd : sellEnd;
                    }
                    ...
                    if (buyParts == sellParts) {
                        if ((buyParts == 0) && (sellParts == 0)) {
                            ...
                            for (k = (i + 1); k <= (i + buyParts); k++) {
                                if (start == k) {
                                    finalArray[k]["NQ"] = pi(finalArray[k]["BQ"]);
                                    finalArray[k]["NV"] = pf(pf(finalArray[k]["BV"]).toFixed(2));
                                    finalArray[k]["AVG"] = pf(finalArray[k]["NV"]) / pi(finalArray[k]["NQ"]);
                                    finalArray[k]["MTM"] = pf(((pf(finalArray[k]["AVG"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["NQ"])).toFixed(2));
                                    finalArray[k]["nq"] = -abs(pi(finalArray[k]["sq"]));
                                    finalArray[k]["nv"] = -abs(pf(pf(finalArray[k]["sv"]).toFixed(2)));
                                    finalArray[k]["avg"] = pf((pf(finalArray[k]["nv"]) / pi(finalArray[k]["nq"])).toFixed(2));
                                    finalArray[k]["mtm"] = pf(((pf(finalArray[k]["avg"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["nq"])).toFixed(2));
                                } else {
                                    finalArray[k]["NQ"] = pi(finalArray[k - 1]["NQ"]) + pi(finalArray[k]["BQ"]);
                                    finalArray[k]["NV"] = pf((pf(finalArray[k - 1]["NV"]) + pf(finalArray[k]["BV"])).toFixed(2));
                                    finalArray[k]["AVG"] = pf((pf(finalArray[k]["NV"]) / pf(finalArray[k]["NQ"])).toFixed(2));
                                    finalArray[k]["MTM"] = pf(((pf(finalArray[k]["AVG"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["NQ"])).toFixed(2));
                                    finalArray[k]["nq"] = pi(finalArray[k - 1]["nq"]) - abs(finalArray[k]["sq"]);
                                    finalArray[k]["nv"] = pf((pf(finalArray[k - 1]["nv"]) - abs(finalArray[k]["sv"])).toFixed(2));
                                    finalArray[k]["avg"] = pf((pf(finalArray[k]["nv"]) / pi(finalArray[k]["nq"])).toFixed(2));
                                    finalArray[k]["mtm"] = pf(((pf(finalArray[k]["avg"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["nq"])).toFixed(2));
                                }
                            }

                            finalArray[endpoint]["SP"] = pf(finalArray[i]["LTP"]);
                            finalArray[endpoint]["SQ"] = abs(pi(finalArray[buyEnd]["NQ"]));
                            finalArray[endpoint]["SV"] = -abs(pf(finalArray[i]["LTP"]) * pi(finalArray[buyEnd]["NQ"]));
                            finalArray[endpoint]["NV"] = pf(finalArray[endpoint]["SV"]) + pf(finalArray[buyEnd]["NV"]);
                            finalArray[endpoint]["NQ"] = 0;
                            finalArray[endpoint]["AVG"] = 0;
                            finalArray[endpoint]["MTM"] = 0;

                            finalArray[endpoint]["bp"] = pf(pf(finalArray[i]["LTP"]).toFixed(2));
                            finalArray[endpoint]["bq"] = abs(pi(finalArray[sellEnd]["nq"]));
                            finalArray[endpoint]["bv"] = abs(pf(finalArray[i]["LTP"]) * pi(finalArray[sellEnd]["nq"]));
                            finalArray[endpoint]["nv"] = pf(finalArray[endpoint]["bv"]) + pf(finalArray[sellEnd]["nv"]);
                            finalArray[endpoint]["nq"] = 0;
                            finalArray[endpoint]["avg"] = 0;
                            finalArray[endpoint]["mtm"] = 0;
                            finalArray[endpoint][" "] = pf(finalArray[endpoint]["NV"]) + pf(finalArray[endpoint]["nv"]);
                        ...
                        for (k = (i + 1); k <= (i + sellParts); k++) {
                            if (start == k) {
                                finalArray[k]["nq"] = -abs(pi(finalArray[k]["sq"]));
                                finalArray[k]["nv"] = -abs(pf(finalArray[k]["sv"]).toFixed(2));
                                finalArray[k]["avg"] = pf((pf(finalArray[k]["nv"]) / pi(finalArray[k]["nq"])).toFixed(2));
                                finalArray[k]["mtm"] = pf(((pf(finalArray[k]["avg"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["nq"])).toFixed(2));
                            } else {
                                finalArray[k]["nq"] = pi(finalArray[k - 1]["nq"]) - abs(finalArray[k]["sq"]);
                                finalArray[k]["nv"] = (pf(finalArray[k - 1]["nv"]) - abs(finalArray[k]["sv"])).toFixed(2);
                                finalArray[k]["avg"] = (pf(finalArray[k]["nv"]) / pi(finalArray[k]["nq"])).toFixed(2);
                                finalArray[k]["mtm"] = pf(((pf(finalArray[k]["avg"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["nq"])).toFixed(2));
                            }
                        }

                        if ((sellParts == 0) && (buyParts != 0)) {
                            finalArray[endpoint]["SP"] = abs(pf(pf(finalArray[i]["LTP"]).toFixed(2)));
                            finalArray[endpoint]["SQ"] = abs(pi(finalArray[buyEnd]["NQ"]));
                            finalArray[endpoint]["SV"] = -abs(pf(finalArray[i]["LTP"]) * pi(finalArray[buyEnd]["NQ"]));
                            finalArray[endpoint]["NV"] = pf(finalArray[endpoint]["SV"]) + pf(finalArray[buyEnd]["NV"]);
                            finalArray[endpoint]["NQ"] = 0;
                            finalArray[endpoint]["AVG"] = 0;
                            finalArray[endpoint]["MTM"] = 0;
                            finalArray[endpoint][" "] = pf(pf(finalArray[endpoint]["NV"]).toFixed(2));
                        }

                        if ((buyParts == 0) && (sellParts != 0)) {
                            finalArray[endpoint]["bp"] = pf(finalArray[i]["LTP"]);
                            finalArray[endpoint]["bq"] = abs(pi(finalArray[sellEnd]["nq"]));
                            finalArray[endpoint]["bv"] = abs(pf(finalArray[i]["LTP"]) * pi(finalArray[sellEnd]["nq"]));
                            finalArray[endpoint]["nv"] = pf(finalArray[endpoint]["bv"]) + pf(finalArray[sellEnd]["nv"]);
                            finalArray[endpoint]["nq"] = 0;
            ...
            applyLogic(trimData(result));
        },
        algoNine: function(res, result) {
            var pi = function(a) {
                return parseInt(a);
            }
            ...
            var trimData = function(result) {
                ...
                for (var j = 0; j < result.length; j++) {
                    onePiece = {};
                    onePiece["Date"] = result[j][drogo[0]];
                    onePiece["Open"] = pi(result[j][drogo[1]]);
                    onePiece["High"] = pi(result[j][drogo[2]]);

                    if (j == 0) {
                        highest = onePiece["High"];
                    } else {
                        if (onePiece["High"] > highest) {
                            highest = onePiece["High"];
                        }
                    }

                    onePiece["Low"] = pi(result[j][drogo[3]]);

                    if (j == 0) {
                        lowest = onePiece["Low"];
                    } else {
                        if (onePiece["Low"] < lowest) {
                            lowest = onePiece["Low"];
                        }
                    }

                    onePiece["LTP"] = pi(result[j][drogo[4]]);

                    if (j == (result.length - 1)) {
                        lastPrice = onePiece["LTP"];
                    }


                    onePiece["OH"] = onePiece["High"] - onePiece["Open"];
                    OHsum = OHsum + onePiece["OH"];
                    if (j == 0) {
                        highestOH = onePiece["OH"];
                    } else {
                        if (onePiece["OH"] > highestOH) {
                            highestOH = onePiece["OH"];
                        }
                    }

                    onePiece["OL"] = onePiece["Low"] - onePiece["Open"];
                    OLsum = OLsum + onePiece["OL"];
                    if (j == 0) {
                        lowestOL = onePiece["OL"];
                    } else {
                        if (onePiece["OL"] < lowestOL) {
                            lowestOL = onePiece["OL"];
                        }
                    }

                    onePiece["OLTP"] = abs(onePiece["LTP"] - onePiece["Open"]);
                    OLTPsum = OLTPsum + abs(onePiece["OLTP"]);
                    if (j == (result.length - 1)) {
                        lastOLTP = onePiece["OLTP"];
                    }
                    onePiece[" "] = null;
                    onePiece["AOH"] = null;
                    onePiece["AOL"] = null;
                    ...
                    regenerate.push(onePiece);

                }

                var emptyPiece = {};

                emptyPiece["Date"] = null;
                emptyPiece["Open"] = null;
                emptyPiece["High"] = null;
                emptyPiece["Low"] = null;
                emptyPiece["LTP"] = null;
                emptyPiece["OH"] = null;
                emptyPiece["OL"] = null;
                emptyPiece["OLTP"] = null;
                emptyPiece[" "] = null;
                emptyPiece["AOH"] = null;
                emptyPiece["AOL"] = null;
                emptyPiece["AOLTP"] = null;
                emptyPiece["  "] = null;
                emptyPiece["HOH"] = null;
                emptyPiece["LOL"] = null;
                emptyPiece["LOLTP"] = null;


                for (var k = 0; k < 2; k++) {
                    regenerate.unshift(emptyPiece);
                }

                var firstPiece = {};

                firstPiece["Date"] = null;
                firstPiece["Open"] = null;
                firstPiece["High"] = highest;
                firstPiece["Low"] = lowest;
                firstPiece["LTP"] = lastPrice;
                firstPiece["OH"] = highestOH;
                firstPiece["OL"] = lowestOL;
                firstPiece["OLTP"] = lastOLTP;
                firstPiece[" "] = null;
                firstPiece["AOH"] = null;
                firstPiece["AOL"] = null;
                firstPiece["AOLTP"] = null;
                firstPiece["  "] = null;
                firstPiece["HOH"] = null;
                firstPiece["LOL"] = null;
                firstPiece["LOLTP"] = null;

                regenerate.unshift(firstPiece);

                var averagePiece = {};

                averagePiece["Date"] = null;
                averagePiece["Open"] = null;
                averagePiece["High"] = null;
                averagePiece["Low"] = null;
                averagePiece["LTP"] = null;
                averagePiece["OH"] = pf((pi(OHsum) / initialLength).toFixed(2));
                averagePiece["OL"] = pf((pi(OLsum) / initialLength).toFixed(2));
                averagePiece["OLTP"] = pf((pi(OLTPsum) / initialLength).toFixed(2));
                averagePiece[" "] = null;
                averagePiece["AOH"] = null;
                averagePiece["AOL"] = null;
                averagePiece["AOLTP"] = null;
                averagePiece["  "] = null;
                averagePiece["HOH"] = null;
                averagePiece["LOL"] = null;
                averagePiece["LOLTP"] = null;

                regenerate.push(averagePiece);

                var totalPiece = {};

                totalPiece["Date"] = null;
                totalPiece["Open"] = null;
                totalPiece["High"] = null;
                totalPiece["Low"] = null;
                totalPiece["LTP"] = null;
                totalPiece["OH"] = pi(OHsum);
                totalPiece["OL"] = pi(OLsum);
                totalPiece["OLTP"] = pi(OLTPsum);
                totalPiece[" "] = null;
                totalPiece["AOH"] = null;
                totalPiece["AOL"] = null;
                totalPiece["AOLTP"] = null;
                totalPiece["  "] = null;
                totalPiece["HOH"] = null;
                totalPiece["LOL"] = null;
                totalPiece["LOLTP"] = null;

                regenerate.push(totalPiece);

                for (var v = 3; v < regenerate.length - 2; v++) {
                    regenerate[v]["AOH"] = pf((pf(regenerate[v]["OH"] - (pi(OHsum) / initialLength))).toFixed(2));
                    regenerate[v]["AOL"] = pf((pf(regenerate[v]["OL"] - (pi(OLsum) / initialLength))).toFixed(2));
                    regenerate[v]["AOLTP"] = abs(pf(pf((pf(regenerate[v]["OLTP"]) - (pi(OLTPsum) / initialLength))).toFixed(2)));
                    regenerate[v]["HOH"] = highestOH - regenerate[v]["OH"];
                    regenerate[v]["LOL"] = lowestOL - regenerate[v]["OL"];
                    regenerate[v]["LOLTP"] = lastOLTP - regenerate[v]["OLTP"];
                }
                return regenerate;
            }

            var arr = trimData(result);

            createFile(arr, 1);
        },
        algoTen: function(res, result, checkAt, benchQuant, addMul, addQuan, firstQuan, typ) {
            ...
            var trimData = function(result) {
                ...
                if (drogo.indexOf("LTP") > -1) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        var oneTime = {};
                        oneTime["Date"] = result[i][drogo[0]];
                        oneTime["Open"] = pf(pf(result[i][drogo[1]]).toFixed(2));
                        oneTime["High"] = pf(pf(result[i][drogo[2]]).toFixed(2));
                        oneTime["Low"] = pf(pf(result[i][drogo[3]]).toFixed(2));
                        oneTime["LTP"] = pf(pf(result[i][drogo[4]]).toFixed(2));
                        regenerate.push(oneTime);
                    }
                }
                return regenerate;
            ...
            var finalArray = [];
            var unLapetedBuyQuan = [];
            var unLapetedSellQuan = [];
            var checkAt = checkAt;
            var fs = require("fs");
            var benchQuant = parseInt(benchQuant);
            ...
            var applyLogic = function(arr) {
                ...
                var getNQ = function(k) {
                    ...
                    if (k == 1) {
                        ...
                        if ((finalArray[k]["BP"] == null) && (finalArray[k]["SP"] == null)) {
                            return 0;
                        }

                        if ((finalArray[k]["BP"] == null) && (finalArray[k]["SP"] != null)) {
                            return -Math.abs(finalArray[k]["SQ"]);
                        }

                        if ((finalArray[k]["BP"] != null) && (finalArray[k]["SP"] == null)) {
                            return Math.abs(finalArray[k]["BQ"]);
                        }

                        if ((finalArray[k]["BP"] != null) && (finalArray[k]["SP"] != null)) {
                            return finalArray[k]["BQ"] - finalArray[k]["SQ"];
                        }

                    } else {

                        if ((finalArray[k]["BP"] == null) && (finalArray[k]["SP"] == null)) {
                            return (0 + finalArray[k - 1]["NQ"]);
                        }

                        if ((finalArray[k]["BP"] == null) && (finalArray[k]["SP"] != null)) {
                            return (finalArray[k - 1]["NQ"] - Math.abs(finalArray[k]["SQ"]));
                        }

                        if ((finalArray[k]["BP"] != null) && (finalArray[k]["SP"] == null)) {
                            return (finalArray[k - 1]["NQ"] + Math.abs(finalArray[k]["BQ"]));
                        }

                        if ((finalArray[k]["BP"] != null) && (finalArray[k]["SP"] != null)) {
                            return ((finalArray[k - 1]["NQ"]) - (finalArray[k]["BQ"] - finalArray[k]["SQ"]));
                        }
                ...
                var getNV = function(k) {
                    ...
                    if (k == 1) {
                        ...
                        if ((finalArray[k]["BV"] == null) && (finalArray[k]["SV"] == null)) {
                            return 0;
                        }

                        if ((finalArray[k]["BV"] == null) && (finalArray[k]["SV"] != null)) {
                            return -Math.abs(finalArray[k]["SV"]);
                        }

                        if ((finalArray[k]["BV"] != null) && (finalArray[k]["SV"] == null)) {
                            return Math.abs(finalArray[k]["BV"]);
                        }

                        if ((finalArray[k]["BV"] != null) && (finalArray[k]["SV"] != null)) {
                            return finalArray[k]["BV"] - finalArray[k]["SV"];
                        }

                    } else {

                        if ((finalArray[k]["BV"] == null) && (finalArray[k]["SV"] == null)) {
                            return (0 + finalArray[k - 1]["NV"]);
                        }

                        if ((finalArray[k]["BV"] == null) && (finalArray[k]["SV"] != null)) {
                            return (finalArray[k - 1]["NV"] - Math.abs(finalArray[k]["SV"]));
                        }

                        if ((finalArray[k]["BP"] != null) && (finalArray[k]["SP"] == null)) {
                            return (finalArray[k - 1]["NV"] + Math.abs(finalArray[k]["BV"]));
                        }

                        if ((finalArray[k]["BV"] != null) && (finalArray[k]["SV"] != null)) {
                            return ((finalArray[k - 1]["NV"]) - (finalArray[k]["BV"] - finalArray[k]["SV"]));
                        }
                ...
                for (i = 0; i < finalArray.length; i++) {
                    ...
                    if (buyParts == sellParts) {
                        ...
                        if ((buyParts == 0) && (sellParts == 0)) {
                            ...
                            for (k = (i + 1); k <= (i + buyParts); k++) {
                                if (start == k) {
                                    ...
                                    if (unLapetedBuyQuan.length == 0) {

                                    } else {
                                        for (var q = 0; q < unLapetedBuyQuan.length; q++) {
                                            if (pi(finalArray[i]["LTP"]) > pi(unLapetedBuyQuan[q]["BP"])) {
                                                buyLapetQuan += pi(unLapetedBuyQuan[q]["BQ"]);
                                                unLapetedBuyQuan.splice(q, 1);
                                            }
                                        }
                                    }

                                    if (pi(finalArray[i]["LTP"]) > pi(finalArray[k]["BP"])) {
                                        buyLapetQuan += pi(finalArray[k]["BQ"]);
                                    } else {
                                        unLapetedBuyQuan.push({
                                            "BP": finalArray[k]["BP"],
                                            "BQ": finalArray[k]["BQ"]
                                        });
                                    }
                                    ...
                                    if (unLapetedSellQuan.length == 0) {

                                    } else {
                                        for (var q = 0; q < unLapetedSellQuan.length; q++) {
                                            if (pi(finalArray[i]["LTP"]) < pi(unLapetedSellQuan[q]["SP"])) {
                                                sellLapetQuan += pi(unLapetedSellQuan[q]["SQ"]);
                                                unLapetedSellQuan.splice(q, 1);
                                            }
                                        }
                                    }

                                    if (pi(finalArray[i]["LTP"]) < pi(finalArray[k]["sp"])) {
                                        sellLapetQuan += pi(finalArray[k]["sq"]);
                                    } else {
                                        unLapetedSellQuan.push({
                                            "SP": finalArray[k]["sp"],
                                            "SQ": finalArray[k]["sq"]
                                        });
                                    }
                            ...
                            finalArray[endpoint]["SP"] = pf(finalArray[i]["LTP"]);
                            finalArray[endpoint]["SQ"] = abs(pi(sellLapetQuan));
                            finalArray[endpoint]["SV"] = -abs(pf(finalArray[i]["LTP"]) * pi(sellLapetQuan));
                            finalArray[endpoint]["bp"] = pf(pf(finalArray[i]["LTP"]).toFixed(2));
                            finalArray[endpoint]["bq"] = abs(pi(buyLapetQuan));
                            finalArray[endpoint]["bv"] = abs(pf(finalArray[i]["LTP"]) * pi(buyLapetQuan));
                            i = i + looper;
                        }
                    } else {
                        ...
                        if ((sellParts == 0) && (buyParts != 0)) {
                            finalArray[endpoint]["SP"] = abs(pf(pf(finalArray[i]["LTP"]).toFixed(2)));
                            finalArray[endpoint]["SQ"] = abs(pi(buyLapetQuan));
                            finalArray[endpoint]["SV"] = -abs(pf(finalArray[i]["LTP"]) * pi(buyLapetQuan));
                        }

                        if ((buyParts == 0) && (sellParts != 0)) {
                            finalArray[endpoint]["bp"] = pf(finalArray[i]["LTP"]);
                            finalArray[endpoint]["bq"] = abs(pi(sellLapetQuan));
                            finalArray[endpoint]["bv"] = abs(pf(finalArray[i]["LTP"]) * pi(sellLapetQuan));
                        }
                ...
                var getPreviousLTP = function(i) {
                    if ((finalArray[i]["LTP"] != "") && (finalArray[i]["LTP"] != null)) {
                        return finalArray[i]["LTP"];
                    } else {
                        for (var t = i; t >= 0; t--) {
                            if ((finalArray[t]["LTP"] != "") && (finalArray[t]["LTP"] != null)) {
                                return finalArray[t]["LTP"];
                            }
                        }
                    }
                }
                ...
                for (i = 0; i < finalArray.length; i++) {
                    ...
                    finalArray[i]["NQ"] = getNQ(i);
                    finalArray[i]["NV"] = getNV(i);

                    finalArray[i]["nq"] = getnq(i);
                    finalArray[i]["nv"] = getnv(i);

                    if (finalArray[i]["NQ"] == 0) {
                        finalArray[i]["AVG"] = 0;
                    } else {
                        finalArray[i]["AVG"] = Math.abs(parseFloat((parseFloat(finalArray[i]["NV"]) / parseFloat(finalArray[i]["NQ"])).toFixed(2)));
                    }
                    ...
                    if (i == 0) {
                        ...
                        finalArray[i]["MTM"] = Math.abs((parseFloat(finalArray[i]["AVG"]) - parseFloat(getPreviousLTP(i))) * parseFloat(finalArray[i]["NQ"]));
                        finalArray[i]["mtm"] = Math.abs((parseFloat(finalArray[i]["avg"]) - parseFloat(getPreviousLTP(i))) * parseFloat(finalArray[i]["nq"]));
                    }
                }
        ...
        algoEleven: function(res, result, checkAt, benchQuant, addMul, addQuan, firstQuan, typ) {
            ...
            var applyLogic = function(arr) {
                firstOpen = arr[0]["Open"];
                for (var i = 0; i < arr.length; i++) {
                    arr[i]["FH"] = pf(arr[i]["High"]) - pf(firstOpen);
                    arr[i]["FL"] = abs(pf(arr[i]["Low"]) - pf(firstOpen));
                }
                ...
                for (var i = 0; i < arr.length; i++) {
                    ...
                    oneTime["LOW"] = pf(pf(arr[i]["Low"]).toFixed(2));
                    oneTime["LTP"] = pf(pf(arr[i]["LTP"]).toFixed(2));
                    oneTime["FH"] = pf(pf(arr[i]["FH"]).toFixed(2));
                    oneTime["FL"] = pf(pf(arr[i]["FL"]).toFixed(2));
                    oneTime["BP"] = null;
                    oneTime["BQ"] = null;
                    oneTime["BV"] = null;
                    oneTime["SP"] = null;
                    ...
                    var buyParts = abs(pi(pf(pf(arr[i]["FL"]).toFixed(2)) / checkAt));

                    var sellParts = abs(pi(pf(pf(arr[i]["FH"]).toFixed(2)) / checkAt));
                    ...
                    if (buyParts > sellParts) {
                        for (var j = 1; j <= buyParts; j++) {
                            ...
                            if (j <= sellParts) {
                                ...
                                oneTime["FH"] = null;
                                oneTime["FL"] = null;
                                oneTime["BP"] = pf(firstOpen) - (j * checkAt);
                                oneTime["BQ"] = putQuan;
                                oneTime["BV"] = (pf(firstOpen) - (j * checkAt)) * putQuan;
                                oneTime["SP"] = null;
                                oneTime["SQ"] = null;
                                oneTime["SV"] = null;
                                oneTime["NQ"] = null;
                                ...
                                oneTime["bq"] = null;
                                oneTime["bv"] = null;
                                oneTime["sp"] = pf(firstOpen) + (j * checkAt);
                                oneTime["sq"] = putQuan;
                                oneTime["sv"] = (pf(firstOpen) + (j * checkAt)) * putQuan;
                                oneTime["nq"] = null;
                                oneTime["nv"] = null;
                                oneTime["avg"] = null;
                                oneTime["mtm"] = null;
                ...
                for (i = 0; i < finalArray.length; i++) {
                    ...
                    var buyParts = abs(pi(pf(pf(finalArray[i]["FL"]).toFixed(2)) / checkAt));
                    var sellParts = abs(pi(pf(pf(finalArray[i]["FH"]).toFixed(2)) / checkAt));
        ...
        algoTwelve: function(res, result) {
            var pi = function(a) {
                return parseInt(a);
            }
            ...
            var trimData = function(result) {
                ...
                for (var j = 0; j < result.length; j++) {
                    onePiece = {};
                    onePiece["Date"] = result[j][drogo[1]];
                    onePiece["Open"] = pf(result[j][drogo[2]]);
                    onePiece["High"] = pf(result[j][drogo[3]]);
                    ...
                    onePiece["Low"] = pf(result[j][drogo[4]]);
                    ...
                    onePiece["LTP"] = pf(result[j][drogo[0]]);
                ...
                averagePiece["Low"] = null;
                averagePiece["LTP"] = null;
                averagePiece["OH"] = pf((pf(OHsum) / initialLength).toFixed(2));
                averagePiece["OL"] = pf((pf(OLsum) / initialLength).toFixed(2));
                averagePiece["OLTP"] = pf((pf(OLTPsum) / initialLength).toFixed(2));
                averagePiece[" "] = null;
                averagePiece["AOH"] = null;
                averagePiece["AOL"] = null;
                averagePiece["AOLTP"] = null;
                ...
                totalPiece["Low"] = null;
                totalPiece["LTP"] = null;
                totalPiece["OH"] = pf(OHsum);
                totalPiece["OL"] = pf(OLsum);
                totalPiece["OLTP"] = pf(OLTPsum);
                totalPiece[" "] = null;
                totalPiece["AOH"] = null;
                totalPiece["AOL"] = null;
                totalPiece["AOLTP"] = null;
                ...
                for (var v = 3; v < regenerate.length - 2; v++) {
                    regenerate[v]["AOH"] = pf((pf(regenerate[v]["OH"] - (pf(OHsum) / initialLength))).toFixed(2));
                    regenerate[v]["AOL"] = pf((pf(regenerate[v]["OL"] - (pf(OLsum) / initialLength))).toFixed(2));
                    regenerate[v]["AOLTP"] = abs(pf(pf((pf(regenerate[v]["OLTP"]) - (pf(OLTPsum) / initialLength))).toFixed(2)));
                    regenerate[v]["HOH"] = highestOH - regenerate[v]["OH"];
                    regenerate[v]["LOL"] = lowestOL - regenerate[v]["OL"];
                    regenerate[v]["LOLTP"] = lastOLTP - regenerate[v]["OLTP"];
                }
        ...
        algoThirteen: function(res, result, checkAt, benchQuant, addMul, addQuan, firstQuan, typ, till, gap) {

            var gap = parseInt(gap);

            var till = parseInt(till);
            ...
            var getJ2 = function(j) {

                if (j <= till) {
                    return j;
                } else {
                    return ((till + parseInt(((j + 2) - (till + gap)) / gap)) - 1);
                }

            }

            var getJ1 = function(j) {

                if (j <= till) {
                    return j;
                } else {
                    return ((till + parseInt(((j + 1) - (till + gap)) / gap)) - 1);
                }
            ...
            var applyLogic = function(arr) {
                ...
                for (var i = 0; i < arr.length; i++) {
                    arr[i]["OH"] = pf(arr[i]["High"]) - pf(arr[i]["Open"]);
                    arr[i]["OL"] = abs(pf(arr[i]["Low"]) - pf(arr[i]["Open"]));
                    arr[i]["OCL"] = (pf(arr[i]["LTP"]) - pf(arr[i]["Open"]));
                }
                ...
                for (var i = 0; i < arr.length; i++) {
                    ...
                    oneTime["OH"] = pf(pf(arr[i]["OH"]).toFixed(2));
                    oneTime["OL"] = pf(pf(arr[i]["OL"]).toFixed(2));
                    oneTime["OCL"] = pf(pf(arr[i]["OCL"]).toFixed(2));
                    oneTime["BP"] = null;
                    oneTime["BQ"] = null;
                    oneTime["BV"] = null;
                    oneTime["SP"] = null;
                            ...
                            if (j <= sellParts) {
                                ...
                                if ((addMul != 'null') && (addMul != null)) {
                                    if (j == 1) {
                                        ...
                                        if (firstQuan != 0) {
                                            putQuan = skipper(j) == true ? (benchQuant * Math.pow(addMul, getJ2(j - 2))) : 0;
                                        } else {
                                            putQuan = skipper(j) == true ? (benchQuant * Math.pow(addMul, getJ1(j - 1))) : 0;
                                        }
                                    ...
                                    if (firstQuan != 0) {
                                        ...
                                        putQuan = skipper(j) == true ? ((benchQuant) + (addQuan * getJ1(j - 1))) : 0;
                                    }
                                    ...
                                    if (firstQuan != 0) {
                                        if (j == 1) {
                                            ...
                                            putQuan = skipper(j) == true ? ((benchQuant) + (addQuan * getJ2(j - 2))) : 0;
                                        }
                                    } else {
                                        putQuan = skipper(j) == true ? ((benchQuant) + (addQuan * getJ2(j - 2))) : 0;
                                    }
        ...
        algoFourteen: function(res, result, checkAt, benchQuant, addMul, addQuan, firstQuan, typ, setBase, afterBase, nextMul, y, superBase) {
            ...
            var setBase = pi(setBase);

            var superBase = pi(superBase);

            var uptoJ = pi(setBase / checkAt);

            var checkAt2 = pi(afterBase);

            var nextMul = pi(nextMul);
            ...
            var applyLogic = function(arr) {
                ...
                for (var i = 0; i < arr.length; i++) {
                    ...
                    if (superBase == 0) {
                        var sellParts = pf(arr[i]["OL"]) > setBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(arr[i]["OL"] - setBase).toFixed(2)) / checkAt2))) : abs(pi(pf(pf(arr[i]["OL"]).toFixed(2)) / checkAt));
                        var buyParts = pf(arr[i]["OH"]) > setBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(arr[i]["OH"] - setBase).toFixed(2)) / checkAt2))) : abs(pi(pf(pf(arr[i]["OH"]).toFixed(2)) / checkAt));
                    } else {
                        var sellParts = pf(arr[i]["OL"]) > setBase ? (pf(arr[i]["OL"]) > superBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(superBase - setBase).toFixed(2)) / checkAt2))) : (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(arr[i]["OL"] - setBase).toFixed(2)) / checkAt2)))) : abs(pi(pf(pf(arr[i]["OL"]).toFixed(2)) / checkAt));
                        var buyParts = pf(arr[i]["OH"]) > setBase ? (pf(arr[i]["OH"]) > superBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(superBase - setBase).toFixed(2)) / checkAt2))) : (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(arr[i]["OH"] - setBase).toFixed(2)) / checkAt2)))) : abs(pi(pf(pf(arr[i]["OH"]).toFixed(2)) / checkAt));
                    }

                    var looper = (pi(sellParts) > pi(buyParts)) ? pi(sellParts) : pi(buyParts);
                            ...
                            if (j <= buyParts) {
                                ...
                                if ((addMul != 'null') && (addMul != null)) {
                                    if (j == 1) {
                                        ...
                                        if (firstQuan != 0) {
                                            putQuan = j <= uptoJ ? (benchQuant * Math.pow(addMul, (j - 2))) : ((benchQuant * Math.pow(addMul, (uptoJ - 2))) * Math.pow(nextMul, (j - uptoJ)));
                                        } else {
                                            putQuan = (benchQuant * Math.pow(addMul, (j - 1)));
                                        }
                                ...
                                oneTime["BQ"] = null;
                                oneTime["BV"] = null;
                                oneTime["SP"] = j <= uptoJ ? (pf(arr[i]["Open"]) - (j * checkAt)) : (pf(arr[i]["Open"]) - ((uptoJ * checkAt) + ((j - uptoJ) * checkAt2)));
                                oneTime["SQ"] = putQuan;
                                oneTime["SV"] = (pf(oneTime["SP"]) * putQuan);
                                oneTime["NQ"] = null;
                                oneTime["NV"] = null;
                                oneTime["AVG"] = null;
                                oneTime["MTM"] = null;
                                oneTime["P/L"] = null;
                                oneTime["Month End"] = null;
                                oneTime["bp"] = j <= uptoJ ? (pf(arr[i]["Open"]) + (j * checkAt)) : (pf(arr[i]["Open"]) + ((uptoJ * checkAt) + ((j - uptoJ) * checkAt2)));
                                oneTime["bq"] = putQuan;
                                oneTime["bv"] = (pf(oneTime["bp"]) * putQuan);
                                oneTime["sp"] = null;
                                oneTime["sq"] = null;
                                oneTime["sv"] = null;
                                oneTime["nq"] = null;
                ...
                for (i = 0; i < finalArray.length; i++) {
                    ...
                    if (superBase == 0) {
                        var sellParts = pf(finalArray[i]["OL"]) > setBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(finalArray[i]["OL"] - setBase).toFixed(2)) / checkAt2))) : abs(pi(pf(pf(finalArray[i]["OL"]).toFixed(2)) / checkAt));
                        var buyParts = pf(finalArray[i]["OH"]) > setBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(finalArray[i]["OH"] - setBase).toFixed(2)) / checkAt2))) : abs(pi(pf(pf(finalArray[i]["OH"]).toFixed(2)) / checkAt));
                    } else {
                        var sellParts = pf(finalArray[i]["OL"]) > setBase ? (pf(finalArray[i]["OL"]) > superBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(superBase - setBase).toFixed(2)) / checkAt2))) : (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(finalArray[i]["OL"] - setBase).toFixed(2)) / checkAt2)))) : abs(pi(pf(pf(finalArray[i]["OL"]).toFixed(2)) / checkAt));
                        var buyParts = pf(finalArray[i]["OH"]) > setBase ? (pf(finalArray[i]["OH"]) > superBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(superBase - setBase).toFixed(2)) / checkAt2))) : (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(finalArray[i]["OH"] - setBase).toFixed(2)) / checkAt2)))) : abs(pi(pf(pf(finalArray[i]["OH"]).toFixed(2)) / checkAt));
                    }

                    looper = (sellParts > buyParts) ? sellParts : buyParts;
                    ...
                    if (sellParts == buyParts) {
                        ...
                        sellEnd = i + sellParts;
                        buyEnd = i + buyParts;
                        endpoint = (sellEnd > buyEnd) ? sellEnd : buyEnd;
                    }
                    ...
                    if (sellParts == buyParts) {
                        if ((sellParts == 0) && (buyParts == 0)) {
                            ...
                            for (k = (i + 1); k <= (i + sellParts); k++) {
                                if (start == k) {
                                    finalArray[k]["NQ"] = pi(finalArray[k]["SQ"]);
                                    finalArray[k]["NV"] = pf(pf(finalArray[k]["SV"]).toFixed(2));
                                    finalArray[k]["AVG"] = pf(finalArray[k]["NV"]) / pi(finalArray[k]["NQ"]);
                                    finalArray[k]["MTM"] = pf(((pf(finalArray[k]["AVG"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["NQ"])).toFixed(2));
                                    finalArray[k]["nq"] = abs(pi(finalArray[k]["bq"]));
                                    finalArray[k]["nv"] = abs(pf(pf(finalArray[k]["bv"]).toFixed(2)));
                                    finalArray[k]["avg"] = pf((pf(finalArray[k]["nv"]) / pi(finalArray[k]["nq"])).toFixed(2));
                                    finalArray[k]["mtm"] = pf(((pf(finalArray[k]["avg"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["nq"])).toFixed(2));
                                } else {
                                    finalArray[k]["NQ"] = pi(finalArray[k - 1]["NQ"]) + pi(finalArray[k]["SQ"]);
                                    finalArray[k]["NV"] = pf((pf(finalArray[k - 1]["NV"]) + pf(finalArray[k]["SV"])).toFixed(2));
                                    finalArray[k]["AVG"] = pf((pf(finalArray[k]["NV"]) / pf(finalArray[k]["NQ"])).toFixed(2));
                                    finalArray[k]["MTM"] = pf(((pf(finalArray[k]["AVG"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["NQ"])).toFixed(2));
                                    finalArray[k]["nq"] = pi(finalArray[k - 1]["nq"]) + abs(finalArray[k]["bq"]);
                                    finalArray[k]["nv"] = pf((pf(finalArray[k - 1]["nv"]) + abs(finalArray[k]["bv"])).toFixed(2));
                                    finalArray[k]["avg"] = pf((pf(finalArray[k]["nv"]) / pi(finalArray[k]["nq"])).toFixed(2));
                                    finalArray[k]["mtm"] = pf(((pf(finalArray[k]["avg"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["nq"])).toFixed(2));
                                }
                            }
                            ...
                            finalArray[endpoint]["sp"] = pf(pf(finalArray[i]["LTP"]).toFixed(2));
                            finalArray[endpoint]["sq"] = abs(pi(finalArray[buyEnd]["nq"]));
                            finalArray[endpoint]["sv"] = -abs(pf(finalArray[i]["LTP"]) * pi(finalArray[buyEnd]["nq"]));
                            finalArray[endpoint]["nv"] = pf(finalArray[endpoint]["sv"]) + pf(finalArray[buyEnd]["nv"]);
                            finalArray[endpoint]["nq"] = 0;
                            finalArray[endpoint]["avg"] = 0;
                            finalArray[endpoint]["mtm"] = 0;
                            finalArray[endpoint]["P/L"] = pf(finalArray[endpoint]["NV"]) + pf(finalArray[endpoint]["nv"]);
                        ...
                        for (k = (i + 1); k <= (i + buyParts); k++) {
                            if (start == k) {
                                finalArray[k]["nq"] = abs(pi(finalArray[k]["bq"]));
                                finalArray[k]["nv"] = abs(pf(finalArray[k]["bv"]).toFixed(2));
                                finalArray[k]["avg"] = pf((pf(finalArray[k]["nv"]) / pi(finalArray[k]["nq"])).toFixed(2));
                                finalArray[k]["mtm"] = pf(((pf(finalArray[k]["avg"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["nq"])).toFixed(2));
                            } else {
                                finalArray[k]["nq"] = pi(finalArray[k - 1]["nq"]) + abs(finalArray[k]["bq"]);
                                finalArray[k]["nv"] = (pf(finalArray[k - 1]["nv"]) + abs(finalArray[k]["bv"])).toFixed(2);
                                finalArray[k]["avg"] = (pf(finalArray[k]["nv"]) / pi(finalArray[k]["nq"])).toFixed(2);
                                finalArray[k]["mtm"] = pf(((pf(finalArray[k]["avg"]) - pf(finalArray[i]["LTP"])) * pi(finalArray[k]["nq"])).toFixed(2));
                            }
                        }
                        ...
                        if ((buyParts == 0) && (sellParts != 0)) {
                            finalArray[endpoint]["BP"] = abs(pf(pf(finalArray[i]["LTP"]).toFixed(2)));
                            finalArray[endpoint]["BQ"] = abs(pi(finalArray[sellEnd]["NQ"]));
                            finalArray[endpoint]["BV"] = abs(pf(finalArray[i]["LTP"]) * pi(finalArray[sellEnd]["NQ"]));
                            finalArray[endpoint]["NV"] = pf(finalArray[endpoint]["BV"]) - pf(finalArray[sellEnd]["NV"]);
                            finalArray[endpoint]["NQ"] = 0;
                            finalArray[endpoint]["AVG"] = 0;
                            finalArray[endpoint]["MTM"] = 0;
                            finalArray[endpoint]["P/L"] = pf(pf(finalArray[endpoint]["NV"]).toFixed(2));
                        }
                ...
                if (y == null) {
                    yoYo = finalArray[0]["DATE"].substring(3, finalArray[0]["DATE"].length);
                } else {
                    yoYo = finalArray[0]["DATE"].substring((finalArray[0]["DATE"].length - 6), finalArray[0]["DATE"].length);
                }
                ...
                for (var i = 1; i < finalArray.length; i++) {
                    ...
                    if (y == null) {
                        if (finalArray[i]["DATE"] != null && (finalArray[i]["DATE"].substring(3, finalArray[i]["DATE"].length)) != yoYo) {
                            yoYo = finalArray[i]["DATE"].substring(3, finalArray[i]["DATE"].length);
                            finalArray[i - 1]["Month End"] = monTotal;
                            monTotal = null;
                        } else {
                            monTotal = monTotal + finalArray[i]["P/L"];

                            if (i == (finalArray.length - 1)) {
                                finalArray[i]["Month End"] = monTotal;
                            }

                        }
                    } else {

                        if (finalArray[i]["DATE"] != null && (finalArray[i]["DATE"].substring((finalArray[i]["DATE"].length - 6), finalArray[i]["DATE"].length)) != yoYo) {
                            yoYo = finalArray[i]["DATE"].substring((finalArray[i]["DATE"].length - 6), finalArray[i]["DATE"].length);
                            finalArray[i - 1]["Month End"] = monTotal;
                            monTotal = null;
                        } else {
                            monTotal = monTotal + finalArray[i]["P/L"];
        ...
        algoFifteen: function(res, result, checkAt, benchQuant, addMul, addQuan, firstQuan, typ, setBase, afterBase, nextMul, y, superBase) {
            ...
            var applyLogic = function(arr) {
                ...
                for (var i = 0; i < arr.length; i++) {
                    ...
                    if (superBase == 0) {
                        var buyParts = pf(arr[i]["OL"]) > setBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(arr[i]["OL"] - setBase).toFixed(2)) / checkAt2))) : abs(pi(pf(pf(arr[i]["OL"]).toFixed(2)) / checkAt));
                        var sellParts = pf(arr[i]["OH"]) > setBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(arr[i]["OH"] - setBase).toFixed(2)) / checkAt2))) : abs(pi(pf(pf(arr[i]["OH"]).toFixed(2)) / checkAt));
                    } else {
                        var buyParts = pf(arr[i]["OL"]) > setBase ? (pf(arr[i]["OL"]) > superBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(superBase - setBase).toFixed(2)) / checkAt2))) : (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(arr[i]["OL"] - setBase).toFixed(2)) / checkAt2)))) : abs(pi(pf(pf(arr[i]["OL"]).toFixed(2)) / checkAt));
                        var sellParts = pf(arr[i]["OH"]) > setBase ? (pf(arr[i]["OH"]) > superBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(superBase - setBase).toFixed(2)) / checkAt2))) : (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(arr[i]["OH"] - setBase).toFixed(2)) / checkAt2)))) : abs(pi(pf(pf(arr[i]["OH"]).toFixed(2)) / checkAt));
                    }
                ...
                for (i = 0; i < finalArray.length; i++) {
                    ...
                    if (superBase == 0) {
                        var buyParts = pf(finalArray[i]["OL"]) > setBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(finalArray[i]["OL"] - setBase).toFixed(2)) / checkAt2))) : abs(pi(pf(pf(finalArray[i]["OL"]).toFixed(2)) / checkAt));
                        var sellParts = pf(finalArray[i]["OH"]) > setBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(finalArray[i]["OH"] - setBase).toFixed(2)) / checkAt2))) : abs(pi(pf(pf(finalArray[i]["OH"]).toFixed(2)) / checkAt));
                    } else {
                        var buyParts = pf(finalArray[i]["OL"]) > setBase ? (pf(finalArray[i]["OL"]) > superBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(superBase - setBase).toFixed(2)) / checkAt2))) : (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(finalArray[i]["OL"] - setBase).toFixed(2)) / checkAt2)))) : abs(pi(pf(pf(finalArray[i]["OL"]).toFixed(2)) / checkAt));
                        var sellParts = pf(finalArray[i]["OH"]) > setBase ? (pf(finalArray[i]["OH"]) > superBase ? (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(superBase - setBase).toFixed(2)) / checkAt2))) : (abs(pi(pf(pf(setBase).toFixed(2)) / checkAt)) + abs(pi(pf(pf(finalArray[i]["OH"] - setBase).toFixed(2)) / checkAt2)))) : abs(pi(pf(pf(finalArray[i]["OH"]).toFixed(2)) / checkAt));
                    }
        ...
        algoSixteen: function(res, result, peDataFifteen, ceDataFifteen, peDataSixteen, ceDataSixteen, year) {

            peFifteen = peDataFifteen;
            ceFifteen = ceDataFifteen;
            peSixteen = peDataSixteen;
            ceSixteen = ceDataSixteen;
            ...
            var parseProperDate = function(date) {
                var patt = /-/;
            ...
            var getCEFifteen = function(date, strikePrice) {

                var date = parseProperDate(date);

                for (var i = 0; i < ceFifteen.length; i++) {
                    var day = ceFifteen[i]["Date"].substring(0, 2);
                    var month = ceFifteen[i]["Date"].substring(3, 6);
                    var year = ceFifteen[i]["Date"].substring(9, 11);
                    var compareDate = day + "-" + month + "-" + year;
                    var compareStrikePrice = ceFifteen[i]["Strike Price"];
                    if ((date == compareDate) && (strikePrice == compareStrikePrice)) {
                        var obj = {
                            "Open": ceFifteen[i]["Open"],
                            "High": ceFifteen[i]["High"],
                            "Low": ceFifteen[i]["Low"],
                            "LTP": ceFifteen[i]["LTP"]
                        }
                        return obj;
            ...
            var getPEFifteen = function(date, strikePrice) {

                var date = parseProperDate(date);

                for (var i = 0; i < peFifteen.length; i++) {
                    var day = peFifteen[i]["Date"].substring(0, 2);
                    var month = peFifteen[i]["Date"].substring(3, 6);
                    var year = peFifteen[i]["Date"].substring(9, 11);
                    var compareDate = day + "-" + month + "-" + year;
                    var compareStrikePrice = peFifteen[i]["Strike Price"];
                    if ((date == compareDate) && (strikePrice == compareStrikePrice)) {
                        var obj = {
                            "Open": peFifteen[i]["Open"],
                            "High": peFifteen[i]["High"],
                            "Low": peFifteen[i]["Low"],
                            "LTP": peFifteen[i]["LTP"]
                        }
                        return obj;
            ...
            var getCESixteen = function(date, strikePrice) {

                var date = parseProperDate(date);

                for (var i = 0; i < ceSixteen.length; i++) {
                    var day = ceSixteen[i]["Date"].substring(0, 2);
                    var month = ceSixteen[i]["Date"].substring(3, 6);
                    var year = ceSixteen[i]["Date"].substring(9, 11);
                    var compareDate = day + "-" + month + "-" + year;
                    var compareStrikePrice = ceSixteen[i]["Strike Price"];
                    if ((date == compareDate) && (strikePrice == compareStrikePrice)) {
                        var obj = {
                            "Open": ceSixteen[i]["Open"],
                            "High": ceSixteen[i]["High"],
                            "Low": ceSixteen[i]["Low"],
                            "LTP": ceSixteen[i]["LTP"]
                        }
                        return obj;
            ...
            var getPESixteen = function(date, strikePrice) {

                var date = parseProperDate(date);

                for (var i = 0; i < peSixteen.length; i++) {
                    var day = peSixteen[i]["Date"].substring(0, 2);
                    var month = peSixteen[i]["Date"].substring(3, 6);
                    var year = peSixteen[i]["Date"].substring(9, 11);
                    var compareDate = day + "-" + month + "-" + year;
                    var compareStrikePrice = peSixteen[i]["Strike Price"];
                    if ((date == compareDate) && (strikePrice == compareStrikePrice)) {
                        var obj = {
                            "Open": peSixteen[i]["Open"],
                            "High": peSixteen[i]["High"],
                            "Low": peSixteen[i]["Low"],
                            "LTP": peSixteen[i]["LTP"]
                        }
                        return obj;
            ...
            if (drogo.indexOf("LTP") > -1) {
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    if (year == 1) {
                        ...
                        var ohllCE = getCEFifteen(result[i][drogo[1]], (Math.floor(pi(result[i][drogo[2]]) / 100) * 100));
                        var ohllPE = getPEFifteen(result[i][drogo[1]], (Math.ceil(pi(result[i][drogo[2]]) / 100) * 100));

                        oneTime["DATE"] = result[i][drogo[1]];
                        oneTime["OPEN"] = pf(pf(result[i][drogo[2]]).toFixed(2));
                        oneTime["HIGH"] = pf(pf(result[i][drogo[3]]).toFixed(2));
                        oneTime["LOW"] = pf(pf(result[i][drogo[4]]).toFixed(2)); //vivek
                        oneTime["LTP"] = pf(pf(result[i][drogo[0]]).toFixed(2));
                        oneTime[" "] = null;
                        oneTime["CE STK"] = Math.floor(pi(oneTime["OPEN"]) / 100) * 100;
                        oneTime["CE"] = null;
                        oneTime["OPEN CE"] = ohllCE["Open"];
                        oneTime["HIGH CE"] = ohllCE["High"];
                        oneTime["LOW CE"] = ohllCE["Low"];
                        oneTime["LTP CE"] = ohllCE["LTP"];
                        oneTime["  "] = null;
                        oneTime["PE STK"] = Math.ceil(pi(oneTime["OPEN"]) / 100) * 100;
                        oneTime["PE"] = null;
                        oneTime["OPEN PE"] = ohllPE["Open"];
                        oneTime["HIGH PE"] = ohllPE["High"];;
                        oneTime["LOW PE"] = ohllPE["Low"];
                        oneTime["LTP PE"] = ohllPE["LTP"];
                        regenerate.push(oneTime);
                    }
                    ...
                    if (year == 2) {
                        ...
                        var ohllCE = getCESixteen(result[i][drogo[0]], (Math.floor(pi(result[i][drogo[1]]) / 100) * 100));
                        var ohllPE = getPESixteen(result[i][drogo[0]], (Math.ceil(pi(result[i][drogo[1]]) / 100) * 100));
            ...
            createFile(regenerate);
        },
        algoSeventeen: function(arr, plusValue, initialQuantity, multipleValue, udAverage) {
            ...
            var currentStoploss = null;

            var mul = pi(multipleValue);

            var plusValue = pf(plusValue);

            var currentQuantities = pi(initialQuantity);

            var firstAverage = null;

            var udAverage = udAverage;

            var getPartsOfPlusValue = function(cv, bm) {
                return pi((cv - bm).toFixed(2) / plusValue);
            }

            var checkIfGoingHigh = function(i) {
                if ((pf(arr[i]["CURRENT"]) > pf(arr[i - 1]["CURRENT"])) && (pf(arr[i - 1]["CURRENT"]) > pf(arr[i - 2]["CURRENT"]))) {
                    return true;
                }
            }

            var checkIfGoingLow = function(i) {
                if ((pf(arr[i]["CURRENT"]) < pf(arr[i - 1]["CURRENT"])) && (pf(arr[i - 1]["CURRENT"]) < pf(arr[i - 2]["CURRENT"]))) {
                    return true;
                }
            }

            var putTamJham = function(arr, i) {
                ...
                if (i == 0) {
                    ...
                    arr[i]["BP"] = arr[i]["BP"] == null ? 0 : arr[i]["BP"];
                    arr[i]["BQ"] = arr[i]["BQ"] == null ? 0 : arr[i]["BQ"];
                    arr[i]["BV"] = arr[i]["BV"] == null ? 0 : arr[i]["BV"];
                    arr[i]["SP"] = arr[i]["SP"] == null ? 0 : arr[i]["SP"];
                    arr[i]["SQ"] = arr[i]["SQ"] == null ? 0 : arr[i]["SQ"];
                    arr[i]["SV"] = arr[i]["SV"] == null ? 0 : arr[i]["SV"];
                    arr[i]["NQ"] = arr[i - 1]["NQ"] + (arr[i]["BQ"] == 0 ? (arr[i]["SQ"] == 0 ? 0 : -Math.abs(arr[i]["SQ"])) : arr[i]["BQ"]);
                    arr[i]["NV"] = arr[i - 1]["NV"] + (arr[i]["BQ"] == 0 ? (arr[i]["SQ"] == 0 ? 0 : -Math.abs(arr[i]["SV"])) : (arr[i]["BV"]));

                    arr[i]["AVG"] = arr[i]["NQ"] == 0 ? 0 : pf(((arr[i]["NV"]) / (arr[i]["NQ"])).toFixed(2));

                    if (arr[i - 1]["AVG"] == null) {

                        firstAverage = arr[i]["AVG"];

                    }

                    arr[i]["MTM"] = pf((((arr[i]["AVG"]) - (arr[i]["CURRENT"])) * (arr[i]["NQ"])).toFixed(2));

                    if (udAverage > 0) {

                        if ((arr[i]["AVG"] - firstAverage) > udAverage) {
                            ...
                            currentQuantities = pi(initialQuantity);
                    ...
                    if (udAverage < 0) {
                        ...
                        if ((firstAverage - arr[i]["AVG"]) < udAverage) {
                ...
                if (toDo == "h" || toDo == "l") {
                    ...
                    if (toDo == "h") {
                        ...
                        if (currentStoploss == null) {
                            ...
                            currentPrice = pf(arr[i]["CURRENT"]);

                            if (arr[i]["CURRENT"] > arr[i - 1]["CURRENT"]) {
                                currentStoploss = pf(currentPrice) - plusValue;
                                status = 0;

                                arr[i]["BP"] = pf(currentPrice);

                                currentQuantities = pi(initialQuantity);

                                arr[i]["BQ"] = currentQuantities;

                                arr[i]["STOPLOSS"] = currentStoploss;
                                arr[i]["BV"] = (arr[i]["BP"]) * (arr[i]["BQ"]);
                            ...
                            if ((arr[i]["CURRENT"] < arr[i - 1]["CURRENT"])) {
                                ...
                                arr[i]["SP"] = pf(currentPrice);

                                currentQuantities = pi(initialQuantity);

                                arr[i]["SQ"] = currentQuantities;

                                arr[i]["STOPLOSS"] = currentStoploss;
                                arr[i]["SV"] = (arr[i]["SP"]) * (arr[i]["SQ"]);
                            ...
                            if (status == 1) {
                                ...
                                plusParts = getPartsOfPlusValue(currentPrice, currentStoploss);

                                if (plusParts > 0) {
                                    status = 0;

                                    arr[i]["BP"] = pf(currentStoploss + plusValue);

                                    arr[i]["BQ"] = currentQuantities;

                                    currentStoploss = pf(arr[i]["BP"]);
                            ...
                            if (status == 0) {
                                ...
                                if (plusParts < 0) {
                                    ...
                                    arr[i]["SP"] = pf(currentStoploss - plusValue);

                                    arr[i]["SQ"] = currentQuantities;

                                    currentStoploss = pf(arr[i]["SP"]);
                            ...
                            if (restart == 1) {
                                ...
                                if (pi(arr[i]["NQ"]) < 0) {
                                    ...
                                    emptyObject = {
                                        ...
                                        "STOPLOSS": null,
                                        "BP": arr[i]["CURRENT"],
                                        "BQ": Math.abs(arr[i]["NQ"]),
                                        "BV": (arr[i]["CURRENT"] * Math.abs(arr[i]["NQ"])),
                                        "SP": null,
                                        "SQ": null,
                                        "SV": null,
                                        "NQ": 0,
                                        "NV": ((arr[i]["CURRENT"] * Math.abs(arr[i]["NQ"])) + (arr[i]["NV"])),
                                        "AVG": null,
                                        "MTM": null
                                    }

                                    arr.splice(i + 1, 0, emptyObject);
                                ...
                                if (pi(arr[i]["NQ"]) > 0) {
                                    ...
                                    emptyObject = {
                                        ...
                                        "BV": null,
                                        "SP": arr[i]["CURRENT"],
                                        "SQ": -Math.abs(arr[i]["NQ"]),
                                        "SV": (arr[i]["CURRENT"] * (-Math.abs(arr[i]["NQ"]))),
                                        "NQ": 0,
                                        "NV": ((arr[i]["CURRENT"] * (-Math.abs(arr[i]["NQ"]))) + (arr[i]["NV"])),
                                        "AVG": null,
                                        "MTM": null
                    ...
                    if (checkIfGoingHigh(i)) {

                        starter = pf(arr[i]["CURRENT"]);

                        toDo = "h";
                    }

                    if (checkIfGoingLow(i)) {
        ...
        putGaps: function(arr, gapValue) {
            ...
            var trimData = function(result) {
                ...
                if (drogo.indexOf("LTP") > -1) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        oneTime["LOW"] = pf(pf(result[i][drogo[4]]).toFixed(2));
                        oneTime["LTP"] = pf(pf(result[i][drogo[5]]).toFixed(2));
                        oneTime["OH"] = pf(pf(oneTime["OPEN"] - oneTime["HIGH"]).toFixed(2));
                        oneTime["OL"] = pf(pf(oneTime["OPEN"] - oneTime["LOW"]).toFixed(2));
                        oneTime["OCL"] = pf(pf(oneTime["OPEN"] - oneTime["LTP"]).toFixed(2));
                        regenerate.push(oneTime);
                    }
                }
                return regenerate;
            ...
            for (var i = 1; i < toBeGapped.length; i++) {

                for (j = 0; j < gapValue; j++) {

                    toBeGapped.splice(i, 0, onePiece);
            ...
            that.functions.createFile(toBeGapped, 1);
